...
%
Efficacy              & The ratio $\frac{\text{energy service}}{\text{energy input}}$. \vspace{1mm} \\
%
Efficiency            & The ratio $\frac{\text{output}}{\text{input}}$, often for energy. \vspace{1mm} \\
%
...
\multirow{2}{*}{Intensity}  & A ratio of unlike quantities, \\
                            & for example $\mft{R} = \frac{\text{resource consumption}}{\text{GDP}}$. \vspace{1mm} \\
%
