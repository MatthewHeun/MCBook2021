...
%
\multirow{2}{*}{Efficacy}   & The ratio $\frac{\text{energy service}}{\text{energy input}}$, with different units \\
...
\multirow{3}{*}{EROI} & Energy return on investment, a key metric \\
                      ...
                      & for an energy production system. \vspace{1mm} \\
%
...
%
\multirow{3}{*}{Intensity}  & A ratio of unlike quantities, \\
...
\multirow{2}{*}{Resources}  & Material extracted from the natural environment \\
                            & for the purpose of human consumption.\vspace{1mm} \\
%
\multirow{2}{*}{Strong sustainability} & Using resources slower than \\
