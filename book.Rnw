...
% See https://tex.stackexchange.com/questions/432885/include-section-number-when-referencing-enum-item
% for a possible way to include chapter numbers with question and project references.
...
\noindent
This book presents many facets of our sustainability challenges.
Sustainability is challenging for many reasons.
...
And aspects of sustainability can be expected to change through time as society
develops new technologies, 
transitions to new resources, and
discovers new ways to use resources.

Because of the dynamic and multifaceted nature of sustainability challenges, 
