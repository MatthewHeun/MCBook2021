...
library(geosphere)   # For map circles
...
\cleardoublepage
    ...
    \Sexpr{knit_child("chapters/ch06-CarbonIntensity/ch06-CarbonIntensity.Rnw")}    % \ref{chap:carbon_intensity}
...
%#############################################################
\part{Collective and Personal Actions}
\label{part:actions}
%#############################################################
