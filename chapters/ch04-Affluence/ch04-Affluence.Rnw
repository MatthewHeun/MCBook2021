...
That is, environmental impacts are the result of society's metabolism\index{economy~as society's metabolism}.
...
ecosystem is no longer able to provide ecosystem services\index{ecosystem services}, as
