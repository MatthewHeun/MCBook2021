...
Economic activity may mean literally consumption, as in the case with food,
...
GDP is what we have the most data for and, consequently,
it is the affluence indicator ``everyone'' uses.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Economic growth and contraction}
...
More workers will increase economic output (GDP) but will not increase GDP \emph{per person}.
A greater fraction of the population working, such as with the demographic dividend, 
...
A with a stable population, a steady-state economy would experience no change 
...
many economies are \emph{both} already too large and still growing.
...
(An abstract desire to have lower impacts is not the same as wanting to be poor.)
...
However, even for these people, there is no escaping a relationship to the rest of
humanity.
There is always some participation in the broader economy,
so there is no escaping the sustainability implications of economic activity.

% ****
% I think this chapter needs a sumamry.
% ---MKH
% ****

This chapter's end-of-chapter questions further explore the thorny issues 
of attempting to lower impacts by lowering affluence.
The next two chapters will examine poverty/sustainability dilemma in more detail.
Perhaps, as we hope, there is a way to enjoy a high standard of living \emph{and}
be sustainable.
% ****
% Not sure where this depressing paragraph belongs.
% Is it meant to be a transition from macro and average affluence~\Aparen{}?
% If so, that transition could be signaled better.
% ---MKH
% ****
