...
affluence, and the role of human economic activity in sustainability challenges.
...
what is ``consumed'' is ancillary to what the consumer actually desires. 
...
The energy consumed is just a means to the and end. 
...
slice of bacon, and then to read the news, and then ... 
...
Having a choice between a muffin and a donut is better than if only donuts are 
on the menu. 
...
I’ll trade you \$15 for a haircut. 
You’re happier with the \$15 and I’m happier with the haircut. 
Your opportunity cost (time) was worth less than \$15, so you end up better off. 
My opportunity cost was \$15 but the haircut is worth more than that to me, 
so I'm better off as well.
