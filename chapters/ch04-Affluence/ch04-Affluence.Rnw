...
Fabrics, like clothes\index{clothing} or carpet, are counted as nondurable goods, even if they
...
among economic growth, energy efficiency, and greenhouse gas emissions \\
...
\item One strategy to make electricity grids more efficient is to employ load shedding\index{load shedding}.
...
\item Social, economic, and environmental policies have effects that are 
      ...
      Therefore, banning air travel\index{air travel} might substantially reduce greenhouse
      gas emissions. 
