...
Equation \ref{eq:IPARX} is our conceptual framework for considering sustainability.
...
The impact intensity of resources, $X$, represents the wastes that the economy excretes.
