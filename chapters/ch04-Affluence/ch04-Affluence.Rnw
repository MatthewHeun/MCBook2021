...
Lastly, the productivity of an economy is influenced by the amount of capital 
investment.
Capital is both buildings and equipment, machines, and tools -- all the \emph{things}
...
\item IPCC6's \emph{most optimistic} scenario is a 0.5m sea-level rise by 2100.
      Coastal cities and beach-front properties will be most affected and, in 
      many cases, most able to pay for mitigation. Given the expected future
      costs of fighting sea-level rise, why don't coastal dwellers pay now to 
      prevent future warming? They could pay carbon emitters far from the coasts
      not to emit. What would it take for such a market to develop?
