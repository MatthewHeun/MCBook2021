...
genuine progress indicator\index{genuine progress indicator}.
...
\footnote{
  ...
  whether that's capital\index{capital}, labor\index{labor}, energy\index{energy}, or materials\index{materials}.
...
and
(b)~ improvements to economic productivity\index{productivity!economic}.
...
Energy efficiency\index{energy efficiency} is a type of economic productivity\index{productivity!economic}.
