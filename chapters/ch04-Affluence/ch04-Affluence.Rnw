...
(Because GDP data are self-reported at the national level but are aggregated 
internationally, there can be issues of reliability and transparency, 
in addition to the other caveats about what GDP measures and what it doesn't.)
...
\item Economist Robert Gordon argues that GDP vastly underestimates 
      the benefits to humanity of innovation and new technologies.
