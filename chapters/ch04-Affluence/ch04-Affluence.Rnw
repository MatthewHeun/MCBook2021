...
Often, for these people, independence or being ``off grid\index{off grid}'' is the main attraction.
...
\item Economist Robert Gordon argues that GDP vastly underestimates 
      ...
      One example could be innovations\index{innovation} in clothing over recent decades.
...
\item Research an individual or group who has chosen an off-grid or otherwise
      ...
      have, versus what ``income\index{income}'' did they/do they generate to add to or subtract
