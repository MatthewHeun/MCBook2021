...
Energy efficiency\index{energy efficiency} is a type of economic productivity.
Greater energy efficiency\index{energy efficiency} enables the same or greater economic output
with lesser energy input.
Managing the ``rebound effect,'' which is a result of energy efficiency\index{energy efficiency} improvements,
