...
(usually measured in \$/year) relative to planetary boundaries\index{planetary boundaries}.
...
models.)
First, tying economic level(s) to particular planetary boundaries\index{planetary boundaries} might not be
...
Figure~\ref{fig:FootprintHDIGraph} shows, because income is a factor in HDI\index{Human Development Index (HDI)}.
...
\item Social, economic, and environmental policies have effects that are 
      ...
      For example, air travel results in substantial greenhouse gas emissions\index{CO$_2$ emissions!air travel}.
