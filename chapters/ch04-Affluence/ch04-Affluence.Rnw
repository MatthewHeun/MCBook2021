...
I.e., GDP is the \emph{de facto} standard.
...
that is, sometimes reducing $A$ \emph{increases} (parts of) $I$.
For instance, a company that goes out of business \emph{might} leave behind a source
of environmental contamination with no one left responsible for managing it.
...
****
I edited the above sentence, but may be it is too strong?
Maybe ``no longer able to provide'' needs to be softened?
---MKH
****
...
****
Should we mention Herman Daly here? 
See \url{https://en.wikipedia.org/wiki/Steady-state_economy} 
---MKH
****
...
as was the case in the ancient and medieval worlds.
...
****
There are plenty of references we can add to steady state economy thinking here or in further reading.
---MKH
****
...
There are substantial social and political pressures against de-growth.
And for good reason!
...
****
There are plenty of references we can add to degrowth thinking here or in further reading.
---MKH
****
...
which (a)~consumes only on recycled (and, perhaps, renewable) materials and energy
...
****
There are plenty of references we can add to circular economy thinking here or in further reading.
---MKH
****
...
Maslow (ref here) put forward the above hierarchy of needs, 
which can frame the question of ``what do we really want?''
...
They search for ways to decouple satisfaction of human needs from energy services, energy consumption, and 
CO$_2$ emissions.
...
**** 
Do we really fulfill this promise?
---MKH 
****
...
runs counter to what people want.
