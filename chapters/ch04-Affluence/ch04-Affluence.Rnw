...
Growth in production also means growth in resource extraction\index{resource extraction} and waste emissions.
...
\item Economist Robert Gordon argues that GDP vastly underestimates 
      ...
      vs.\ having microplastic pollution\index{pollution!microplastic}?
