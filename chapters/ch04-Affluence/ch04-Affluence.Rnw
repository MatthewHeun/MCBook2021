...
Note that most national and international economic policy is explicitly and
purposely devoted to increasing affluence and maintaining continual growth for GDP
(as shown in Figures~\ref{fig:AffluenceGraph-Nordhaus} and~\ref{fig:GDPGraph-Nordhaus}),
even though perpetual growth of consumption of finite
resources is ultimately unsustainable. 
...
I.e., environmental impacts are the result of society's metabolism.
...
In fact, growth in GDP per capita~($A$) is the explicit goal of many economic policies.
...
affluence because more workers are needed to gather, process, and use the 
...
level of output. 
(At that point, workers are fully ``tooled up.'')
...
However, if you look close enough, almost all of these ``new goods'' stories 
...
economic growth, measured by GDP per capita---primarily driven by improvements
in material and energy efficiency (that is, ``innovation'')---results not in 
less consumption but more.
****
The preceding sentence could use a rework. 
It is rather complicated. ---MKH
****
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Economic level and alternative economic models}
\label{sec:circular_economy}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

World economies are managed to exhibit continual growth. 
