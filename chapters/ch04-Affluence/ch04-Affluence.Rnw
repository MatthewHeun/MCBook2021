...
As discussed above, 
GDP per capita is measured as consumption per capita.
...
Growth in production also means growth in resource extraction and waste emissions.
So policies that encourage economic growth 
often have negative implications for environmental sustainability.
...
affluence~\Aparen{} because more workers are needed to gather, process, and use the 
additional resources.
That leaves efficiency as the primary means of boosting affluence.
From a sustainability point of view, we should want everything to be used
as efficiently as possible; inefficiency of any kind is not desirable.
...
%..............................
\paragraph{Steady state} \index{economy!steady-state}
%..............................

A steady-state economy\index{economy!steady-state} neither grows nor shrinks.
Its size (measured in \$/year) is constant through time.
...
%..............................
\paragraph{Degrowth} \index{economy!degrowth}\index{degrowth}
%..............................

Advocates of degrowth understand the fact that many economies need to become smaller
to be sustainable.
The degrowth movement promotes
(a)~negative growth in \%/year terms
and 
(b)~smaller economies in \$/year terms.
...
is a \emph{circular} economy, which 
...
A doughnut economy keeps the level of economic activity
...
The doughnut economy imposes both a 
``floor'' and a ``ceiling'' on economic activity,
reducing income disparity between rich and poor and
respecting planetary boundaries.
The doughnut economy model attempts to correct 
one of the flaws of a steady state economy, namely that
some people could remain poor and destitute.
...
(To one degree or another, these following difficulties are shared with the steady-state,
degrowth, and circular economy models.)
First, tying economic level(s) to particular planetary boundaries might not be
straightforward, particularly because we don't know location of the boundaries
with certainty in some cases.
...
degrowth to fit beneath the ceiling
or
...
so there is apparently no way to escape 
...
This chapter defined affluence~\Aparen{} in the IPARX equation and looked at 
historical data of \mft{A} over time. 
Affluence is a challenging topic.
On one hand, growth in affluence can be viewed as the source (or \emph{a} major source)
of our many environmental sustainability challenges.
...
\item Discuss how our perception of our needs is shaped by what is technologically 
      ...
      (President Abraham Lincoln's son William died of a fever
