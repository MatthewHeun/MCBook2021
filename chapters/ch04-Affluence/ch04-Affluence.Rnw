...
\footnote{
  ...
  whether that's capital, labor, energy, or materials.
...
\footnote{
  The productivity of resources (economic output/resource input)
...
additional resources.
That leaves productivity as the primary means of boosting affluence.
...
but will not increase GDP \emph{per person}, affluence.
On the other hand,
...
At some point, there is a \emph{maximum} level of capital productivity.
Beyond that maximum,
expenses to maintain capital exceed the contribution of capital to the economy. 
At the maximum level of capital productivity,
labor will have a maximum level of output because workers are fully ``tooled up.''
...
and
(b)~ improvements to economic productivity.
The majority of the goods and services we consume today did not exist in
1870~\cite{Gordon2016}.
And we consume entirely new categories of goods and services that did not
...
\emph{also} end up being about some form of productivity.
The endless quest to meet our needs more productively
allows spending on \emph{additional} consumption.
Productivity improvements (and resource intensity declines)
...
and energy (Figure~\ref{fig:EnergyIntensityGraph-Nordhaus}) productivity
(that is, innovation of the second type).
Energy efficiency is a type of economic productivity.
Greater energy efficiency enables the same or greater economic output
with lesser energy input.
Managing the ``rebound effect,'' which is a result of energy efficiency improvements,
