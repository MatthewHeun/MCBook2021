...
<<AffluenceGraph-Nordhaus, fig.cap = "Annual world GDP per capita, affluence ($A$) in Equation~\\ref{eq:IPARC}. \\emph{Sources}: data for 1990--2020 from the \\citet{World-Bank:2021un}; data for 1800--1989 inferred from GDP per capita growth rates from \\citet{Nordhaus:1997vi} via \\citet{DeLong:1997ui}.">>=
...
The impact intensity of resources, $C$, represents the wastes that the economy excretes.
...
\item Some (high-end!) apparel has been made a circular economy. The manufacturer
      ...
      such garments as opposed to more bargain clothing (make reference to Equation \ref{eq:IPARC}
      in your answer). 
