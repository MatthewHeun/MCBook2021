...
\section{Summary}
This chapter defines affluence \mft{A} in the IPARX equation and looked at the 
...
between affluence and impacts.
On the other hand, increasing affluence is desirable. 
Indeed, it is the goal of many aspects of social sustainability.
However, growth in affluence puts the burden of lowering impacts \mft{I} on the
other terms on the right-hand side of the IPARX equation:~\mft{P}, \mft{R}, and ~\mft{X}.
