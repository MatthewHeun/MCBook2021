...
(Note that wishing to have lower impacts is not the same as wanting to be poor.)
...
(e.g., wages to government workers and equipment) and net investment (e.g., 
...
Thus, the metabolism of human society is the economy.
...
unsustainable. 
When the economy grows, at some point either demands more resources than the 
...
generation to generation, which is a situation that was a feature of the ancient
and medieval world. 
...
\item Discuss how our perception of our needs is shaped by what is technologically 
      ...
      Consider how having choice(s) creates well being. In times past it was common
