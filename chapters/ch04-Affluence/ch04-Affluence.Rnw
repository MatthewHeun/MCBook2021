...
\ref{fig:FootprintHDIGraph} shows. End-of-chapter questions will explore more
of the thorny issues with attempting to lower impacts by lowering affluence.
...
Thus, GDP may be less useful than other measures of wealth for discussions of 
