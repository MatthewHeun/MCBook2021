...
If affluence $A$ is a cause of impacts \mft{I}, then reducing $A$ is one way to reduce
...
that is, sometimes reducing $A$ \emph{increases} (at least some parts of) \mft{I}.
