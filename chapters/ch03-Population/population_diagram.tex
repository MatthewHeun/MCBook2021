...
\begin{tikzpicture}
    ...
    \draw [-stealth, bend right = 5] ([xshift=3mm, yshift=2mm]agricultural_capital.south) to ([xshift=-4mm, yshift=0mm]pollution.north); 
    \node[above left = -2mm and -2.5mm of pollution] {+};
  \end{tikzpicture}