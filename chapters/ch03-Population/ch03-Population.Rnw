...
The overall death rate will still be greater than than the overall birth rate because of
...
The assumption that population growth leads to starvation
...
Because population would outgrow the food supply (part of affluence), starvation 
would result.
...
Neither prediction has come to pass (to date). 
