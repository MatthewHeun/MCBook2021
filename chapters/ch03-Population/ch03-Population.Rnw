...
activities on animal populations, i.e., this chapter covers $P$ in the IPARX equation.
...
ggplot2::ggplot(data = world) +
  ...
  ggplot2::geom_path(data = v_circle, mapping = ggplot2::aes_string(x = "lon", y = "lat"), colour = mc_title_blue, size = 1) +   
