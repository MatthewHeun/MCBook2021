...
Malthusians think that population growth will mean that we will ``run out'' of 
scarce resources.
Techo-optimists think that more people means more labor, which will lead to 
better ideas, more specialization of labor, and, ultimately, to better, not worse,
standards of living.
...
\item Some electric train systems supply power to the train by energizing
      ...
      What groups or individuals would be especially sensitive to attempts to control population? 
      Explain moral or ethical concerns with population control, either the 
