...
<<PopulationGraph, fig.cap="World population, $P$ in the IPARC equation. \\emph{Source}: \\citet{Roser:2021uu}.">>=
...
(the $A$ term in Equation~\ref{eq:IPARC}).
\end{mcframe}
