...
<<PopulationGraph, fig.cap="World population, $P$ in the IPARC equation. Source: \\citeauthor{Roser:2021uu}~\\cite{Roser:2021uu}.">>=
...
<<UN_population_prospect, fig.cap="Projections of world population. Projections are based on probabilistic models of total fertility and life expectancy at birth from a Bayesian hierarchical model. The light gray region shows a 95~\\% prediction interval. The dark gray region shows a 80~\\% prediction interval. Sources: Historical data from \\citeauthor{Roser:2021uu}~\\cite{Roser:2021uu}; future projections from \\citeauthor{UNEcSoAf:2021vj}~\\cite{UNEcSoAf:2021vj}.">>=
...
\caption{Causal loop diagram of several important feedback loops.
         ...
         Source: \citeauthor{Meadows:1974ut}~\cite[p.~14]{Meadows:1974ut}.}
