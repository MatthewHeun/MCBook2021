...
<<PopulationGraph, fig.cap="World population, $P$ in the IPARC equation~\\cite{Roser:2021uu}. Source: Our World in Data/United Nations Population Division">>=
...
But also, it is difficult to make predictions about the past.
...
Around the year 1 AD there were around 300 million people, representing an average growth rate of about 0.1\%/year.
By 1650 AD, the world population was around 500 million. 
Average growth was slowed because trade and urbanization enabled infectious 
diseases to kill large numbers.
...
used in the World3 population model, and early world population model. 
...
would \emph{cause} catastrophe, usually envisioned as starvation. 
This viewpoint is called \emph{Malthusian} after Thomas Malthus (1766-1834), whose
1798 book suggested that any increase in affluence (what today we would call GDP
per capita) was temporary. 
...
Subsequently, the Industrial Revolution happened and GDP per capita \emph{did}
increase \emph{in spite of}, or alongside of, increasing population -- see 
Figures~\ref{fig:AffluenceGraph-Nordhaus} and~\ref{fig:PopulationGraph}.

Nevertheless, fears of Mathusian catastrophe have not gone away.
...
The opposite point of view is that there are no limits to growth.
Matter and energy are abundant in the universe and (it is thought)
human ingenuity can invent technology to substitute for or replace nonrenewable 
resources.
Resource scarcity will cause prices to rise, thereby incentivizing use of 
alternative resources.
Whereas \emph{Limits to Growth} assumed pollution would grow exponentially but
pollution-control technology would not, it may be technologically possible to produce, for 
example, abundant energy with little to no pollution, such as with wind or solar.

Which of these views is correct? 
Is population growth the source of natural catastrophe or is it a wellspring of labor and 
technology that will give us abundant resources?
In 1980, business professor Julian Simon challenged Ehrlich to a US\$10,000 wager.
Ehrlich could choose any raw material he wanted and a date more than a year away.
If the inflation-adjusted prices had decreased by that date, Simon would win. 
Ehrlich chose copper, chromium, nickel, tin, and tungsten over the time period 
1980 to 1990.
In that decade, world population increased from about 4.46 billion to around
5.33 billion.
Despite experiencing the largest single-decade increase in population in history, 
prices for all five materials decreased, and Ehrlich lost the bet.
If you think that settled the argument, you lose too.
...
Exponential growth can't continue forever with finite resources.
On the other hand, we've done pretty well so far and, by most measures, human 
life is better now than it has ever been.
Whether that can, and will, continue and, if so, for how long seems to depend 
...
\item Notice the population structure shown in Figures \ref{fig:PopulationGraph} 
      ...
      Does this complicate the issues raised in Questions Q3.1 and Q3.2, and if so, how? 
...
\item Is your personal outlook on the future Malthusian or not? Why, and to
      what degree? Are there qualifying statements for you?
      With respect to the Simon-Ehrlich bet, what bets would you take?
      What bets would you propose?

\item Is a wager a good way verify truth? Why or why not? How? 
