...
Figure~\ref{fig:half_population}, with a radius of about 3,300km. 
\begin{figure}
\centering
\includegraphics[width=\linewidth]{chapters/ch03-Population/figures/half_world_population.pdf}
\caption[Half the world's population lives in this circle.]{As of 2015, more than 
...
\item It is interesting to note that Malthus's book was published (1798) just before before 
      Figure~\ref{fig:PopulationGraph} begins (1800). On the one hand, exponential growth
