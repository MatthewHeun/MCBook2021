...
<<half_population, fig.cap="As of 2015, half of the world's population lives in a circle with a radius of 3,300~km centered on Mong Khet, Myanmar \\cite{Quah2015}.">>=
  # See https://r-spatial.org/r/2018/10/25/ggplot2-sf.html for lots of good ggplot map stuff
  # See https://en.wikipedia.org/wiki/Valeriepieris_circle for information about the Valeriepieris Circle
  # See https://en.wikipedia.org/wiki/Mong_Khet_Township for Mong Khet township in Myanmar (21°42′00″N 99°23′00″E)

# Function to draw a projected circle
...
# Make a data frame of lat/lon points centered on 
