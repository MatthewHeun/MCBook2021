...
<<PopulationGraph, fig.cap="World population, $P$ in the IPARC equation~\\cite{Roser:2021uu}. Source: Ou World in Data/United Nations Population Division">>=
...
1798 book suggested that any increase is affluence (what today we would call GDP
per capita) was temporary. 
Increasing affluence, Malthus thought, would lead to population growth, which 
would thereby decrease GDP \ephm{per capita}. 
