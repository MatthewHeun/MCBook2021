...
times above that limit (0.01\% or greater).
...
passenger pidgeons, whales, bison, and megafauna such as the aurochs and giant ground sloth.
...
Furthermore, the UN model accounts for different levels of development in 
...
resulting in a low population growth rate.
...
is an observed pattern that economic development leads to a decrease in mortality 
...
the total human population won't \textit{continue} to grow exponentially. 
