...
used in the World3, an early (and simple) world population model. 
...
The UN projections in Figure~\ref{fig:UN_population_prospect} (not based on the World3 model)
are based on likely interactions among the many variables thought to affect 
birth and death rates, accounting for different levels of development in 
...
On the other hand, slowing of growth is predicated on increasing the $A$ term in 
...
The
\emph{Limits to Growth} assumed pollution wo price of any scarce resource will rise, thereby incentivizing use of 
alternative resources.uld grow exponentially but
...
The History Guy (YouTube) ``\href{The Great Kansas Grasshopper Plague of 1874}
{https://www.youtube.com/watch?v=FxqgBWxLZa0},'' 
published August 17, 2020. \\

Wold3 model online: \url{http://bit-player.org/wp-content/extras/limits/}
