...
\centering
  \begin{tikzpicture}
    [arrow_style/.style={blah}]
    \footnotesize
    \node at (0,0) (investment_rate) {\begin{tabular}{l} Investment \\ rate \end{tabular}};
    \node at (0.75,1.5) (industrial_investment) {\begin{tabular}{l} Industrial \\ investment \end{tabular}};
    \draw [-stealth] (investment_rate) -- (industrial_investment); \node at (0.7,0.9) {+};
    \node at (1.5,3) (industrial_capital) {\begin{tabular}{l} Industrial \\ capital \end{tabular}};
    \draw [-stealth] (industrial_investment) -- (industrial_capital); \node at (1,2.45) {+};
  \end{tikzpicture}
\caption[Causal loop diagram of several important feedback loops in the World3 population model.]
{Causal loop diagram of several important feedback loops in the World3 population model.}
