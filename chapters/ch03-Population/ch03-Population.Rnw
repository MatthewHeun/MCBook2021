...
This area of Southeast Asia has a very high population density.
\begin{figure}
\centering
\includegraphics[width=\linewidth]{chapters/ch03-Population/figures/half_world_population.pdf}
\caption[Half the world's population lives in this circle.]{As of 2015,
half the world's population lives in a circle with a radius of 3,300km \cite{Quah2015}.}
