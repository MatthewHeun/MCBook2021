...
<<PopulationGraph, fig.cap="World population, $P$ in the IPARC equation. Source: Our World in Data~\\cite{Roser:2021uu}.">>=
...
<<UN_population_prospect, fig.cap="Projections of world population. Projections are based on probabilistic models of total fertility and life expectancy at birth from a Bayesian hierarchical model. The light gray region shows a 95~\\% prediction interval. The dark gray region shows a 80~\\% prediction interval. Sources: Historical data from Our World in Data~\\cite{Roser:2021uu}; future projections from United Nations, Department of Economic and Social Affairs, Population Division~\\cite{UNEcSoAf:2021vj}.">>=
...
\caption{Causal loop diagram of several important feedback loops.
         ...
         Source: World3 population model~\cite[p.~14]{Meadows:1974ut}.}
...
If inflation-adjusted prices of those raw materials increased, Erlich would win. 
