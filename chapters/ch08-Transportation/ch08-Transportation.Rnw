...
This is the second of four chapters in Part~\ref{part:sustainability_challenges}
to discuss
areas of life where sustainability challenges are relevant and important.
This chapter covers transportation.
Today, transportation services are provided by cars, trucks, trains, boats, and planes. 
Energy for transportation is 
supplied almost exclusively by liquid petroleum fuels,
because of the high energy densities\index{energy density!liquid fuels} of those fuels
as measured by both energy-to-mass and energy-to-volume ratios.
The U.S.\ transportation sector emits more carbon than any other, 
...
In addition, transportation CO$_2$ emissions are linked to other sectors.
...
Transport service demand levels are usually quantified in
...
calculates a monthly ``Transportation Services Index'' (TSI),
a weighted and indexed measure of
freight traffic and passenger travel
that measures transportation services 
...
But the low share of multi-passenger transportation modes (carpool and mass transit)
indicates that large energy consumption and CO$_2$ emission savings could be obtained 
from a society-wide transition to toher commuting modes besides driving alone.
...
Vehicle efficiency (actually, an ``efficacy'') is usually quantified in distance traveled per volume
...
where appropriate)
lead to improved vehicle efficiency (efficacy).
...
Thus, biofuels are unlikely to provide a long-term solution
...
The material demands for engine and battery fabrication are much higher for EVs than for ICE vehicles.
