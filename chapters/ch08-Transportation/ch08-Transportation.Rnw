...
Figure~\ref{fig:LLNL_energy_sankey} shows that energy for transportation is 
...
<<tonnekm_by_mode, fig.cap="Ton-miles of freight transport by mode, 1980--2018. Pipeline is transportation of liquids (such as fuels) through pipelines. Source: U.S.\\ Bureau of Transportation Statistics~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021vu}.">>=
...
<<TSI, fig.cap="Seasonally-adjusted transportation index data for freight, passenger, and overall services. (2000 = 100) Source: Bureau of Transportation Statistics~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}.">>=
...
# hawkins <- readxl::read_excel(file.path("chapters", "ch08-Transportation", "datasets", "EV data from Hawkins.xlsx"), 
#                               sheet = "data to plot") %>% 
#   tidyr::pivot_longer(cols = c("Base v"))
