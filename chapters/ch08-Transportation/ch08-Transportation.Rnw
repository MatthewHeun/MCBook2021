...
<<passengerkm_by_mode, fig.cap="Passenger-km of personal transport by mode. Source: ">>=
passenger_km_by_mode <- readxl::read_excel(file.path("chapters", "ch08-Transportation", "datasets", "Passenger_kms.xlsx"), 
                   sheet = "data to plot")

# Make graph here. Be careful, and look at the Excel file. 
# Some modes are not meant to be aggregared.
...
tonne_km_by_mode %>% 
  ggplot2::ggplot(mapping = ggplot2::aes_string(x = "Year", y = "tonnekm", fill = "type")) +
  ggplot2::geom_area() +
...
TSI %>% 
  ggplot2::ggplot(mapping = ggplot2::aes_string(x = "Year", y = "value", linetype = "indicator")) + 
  ...
  ggplot2::scale_linetype_manual(values = c(3, 1, 2)) +
  ggplot2::labs(x = ggplot2::element_blank(), 
