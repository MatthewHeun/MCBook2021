...
is the last mile problem~\cite{World-Economic-Forum:2020wf}\index{last mile problem},
...
Another sustainability challenge for transport is the first mile problem\index{first mile problem}
for mass transit.
...
However, EVs can provide benefits in terms of global warming potential~(GWP)
relative to ICE vehicles
if the electricity source includes renewables (as in the ``Ren20'' electricity mix), 
...
a phenomenon known as problem shifting\index{problem shifting}.
...
\item Could driving be more environmentally friendly than walking? 
      ...
      primarily from animal sources, particularly beef, that driving could
...
\item Congestion pricing attempts to attenuate demand for a public good by manipulating its price.
      ...
      The objectives of congestion pricing are many and various: improved
      ...
      Some common objections to congestion pricing relate to (hypothetical) displaced traffic to suburbs,
...
\item \href{www.strongtowns.org}{Strong Towns.org} defines a road as a high-speed 
      ...
      and stroads as dangerous and expensive hybrids that are ultimately ineffective
...
\item Driving has long been a competitive sport. One lesser-known form of 
      ...
      boost fuel efficiency and make hypermiling techniques safer to deploy
      more broadly. 
...
\item Research the term problem shifting.
      ...
      Can you identify arguments both in favor of and opposed to intentional problem shifting?
