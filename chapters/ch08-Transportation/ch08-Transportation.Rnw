...
\item Houston bus route redesign. Iterative design.

\item the hassle of air travel. The \emph{only} important thing is cheap fare.

\item various ways to solve last-mile personal commute. False reasons why we don't
      bike to work: sweaty. change clothes. (get a Dutch bike).
      Carpooling (in part a last mile problem).
      
\item Affluence of travel. What's your perception of the value of travel to you?
      Figure 8.3.
      
\item Ferry vs. bridge. What's the objective function? Minimum cost per year (given
      what set of assumptions? If you build it, they will come!)? Fastest service?
      
\item Hypermiling and autonomous vehicles. right to drive.
