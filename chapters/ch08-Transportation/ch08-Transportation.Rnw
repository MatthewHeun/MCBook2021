...
in the U.S.,
meaning automobiles\index{automobile} travelling on roads.
...
%^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
\label{mcframe_EV}
Automobile\index{utomobile} technology is one of many arenas in which sustainability tradeoffs are observed.
