...
\item Congestion pricing attempts to attenuate demand for a public good by manipulating its price.
      ...
      increasingly common. The city of London has had such a scheme since 2003 and
      congestion pricing is currently being considered for New York City.
...
\item Strong Towns defines a road as a high-speed connection between two places,
