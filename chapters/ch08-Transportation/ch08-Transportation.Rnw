...
and mineral resource depletion\index{mineral resource depletion (MRD)})
...
don't end with the tradeoff between GHG emissions and mineral resource depletion\index{mineral resource depletion (MRD)} 
discussed above.
...
\item Under the right conditions (an electricity mix that includes renewable sources
      ...
      at the expense of increased mineral resource depletion\index{mineral resource depletion (MRD)}.
      The tradeoff between GHG emissions and mineral resource depletion\index{mineral resource depletion (MRD)} is
      ...
      for increased mineral resource depletion\index{mineral resource depletion (MRD)}?
      Why or why not?
