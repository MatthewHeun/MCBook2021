...
\item In 2008, various media outlets reported on claims that, under certain conditions,
      driving could be more environmentally friendly than walking. In response, 
      the Pacific Institute developed a study paper to evaluate the matter. 
      In their analysis, they found~\cite{CohenH2008} that if your calories came
      ...
      round trip, say walking to a store and back. The analysis included the 
      ...
      miles (3200 km). Which transport mode will have the least emissions?
...
\item City center travel exclusion zones. Why do we have a quest to end raod use
      if transport is what we want? Utilitarianism?
