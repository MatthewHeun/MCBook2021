...
<<auto_gwp, fig.cap = "Normalized environmental impacts of three different automobiles for 150,000~km service life. ``GWP'' is global warming potential. ``MRD'' is mineral resource depletion. ``ICE'' means internal combustion engine vehicles. ``EV'' means electric vehicle. ``Gas'' indicates a gasoline-powered vehicle. ``Euro'' indicates the European electricity mix. ``Coal'' indicates electricity exclusively from coal. ``Use phase'' excludes fuels. Source: \\citet[Fig.~1]{Hawkins_2012}.">>=
