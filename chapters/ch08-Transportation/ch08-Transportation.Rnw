...
a transportation service efficacy metric instead of an energy efficiency\index{energy efficiency} metric
to evaluate the effectiveness of transportation services. 
(See page~\pageref{page:efficiency_efficacy} for more details about
the differences between energy efficiency\index{energy efficiency} and energy service efficacy.)
...
\item Under the right conditions (an electricity mix that includes renewable sources
      ...
      provide GHG emissions reductions relative 
...
\item The box on page~\pageref{page:efficiency_efficacy} highlights 
      ...
      moving from energy efficiency\index{energy efficiency} to service efficacy. 
      ...
      Develop or find an energy efficiency\index{energy efficiency} or a machine efficacy for your challenge
      ...
      What changes when you move from energy efficiency\index{energy efficiency} or machine efficacy to service efficacy?
