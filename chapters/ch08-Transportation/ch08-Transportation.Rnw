...
Vehicle fuel economy\index{fuel economy} (an efficacy, not an efficiency)
...
Fuel economy\index{fuel economy}, by definition,
...
However, EVs can provide benefits in terms of global warming potential~(GWP)\index{global warming potential (GWP)}
