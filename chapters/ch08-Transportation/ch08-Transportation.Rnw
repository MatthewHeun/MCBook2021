...
that measures transportation services output~\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}.
...
(b) a recession (see 2009) and a pandemic (see 2020) are good ways
...
<<TSI, fig.cap="Transportation services index. Source: Bureau of Transportation Statistics~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}">>=
...
The small share of daily commuters who use multi-passenger transportation modes 
(carpool and mass transit) indicates that large
energy consumption and CO$_2$ emission savings could be obtained 
from a commuting mode away from driving alone.
...
**** Figure of freight transport demand vs. time. ****
...
in recent years. 
The result is rising energy consumption for commercial last-mile deliveries
...
Demand for transportation services correlates with
economic activity, 
one reason that economic growth and energy consumption are tightly linked.
...
Burning liquid fossil fuels for transportation services
has global warming\index{global warming}
implications, and
...
Indeed, Table~\ref{tab:corrected_co2_emissions} shows that U.S.\
greenhouse gas emissions from transportation comprise
\Sexpr{US_CO2_by_sector %>% 
dplyr::filter(Sector == "Transportation") %>% 
magrittr::extract2("Proportion [\\%]") %>% 
round(1)}~\% 
of all U.S.\ CO$_2$ emissions, 
making transportation the largest emitting sector.
