...
to the purchaser.
The rise of e-commerce\index{e-commerce} has caused unparalleled growth in last-mile transport
...
\item Congestion pricing\index{congestion pricing} attempts to attenuate demand for a public good by manipulating its price.
      ...
      The London has had such a scheme since 2003 and congestion pricing\index{congestion pricing} 
      ...
      Some common objections to congestion pricing\index{congestion pricing} relate to (hypothetical) displaced traffic to suburbs,
