...
<<passengerkm_by_mode, fig.cap="U.S.\\ passenger-km of personal transport by mode. ``Intercity'' is rail travel via Amtrak. ``Transit'' is public transit of all types (ferry, subway, bus, etc.). ``Air'' is U.S.\\ domestic air carriers. ``Highway'' is automobile traffic. Source: \\citeauthor{passenger_km}~\\cite{passenger_km}.">>=
...
<<tonnekm_by_mode, fig.cap="Freight transport by mode, 1980--2018. ``Pipeline'' is transportation of liquids (such as fuels) through pipelines. Source: \\citeauthor{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021vu}~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021vu}.">>=
...
freight traffic and passenger travel.
...
<<TSI, fig.cap="Seasonally-adjusted transportation index data for freight, passenger, and overall transportation services. (2000 = 100) Source: \\citeauthor{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}.">>=
...
<<commuter_percentage_by_mode, fig.cap="Percentage of U.S.\\ commutes by mode. Note: ``Taxi'' includes motorcycles and other commuting modes. Source: \\citeauthor{U.S.-DOT-BTS:2019ww}~\\cite{U.S.-DOT-BTS:2019ww}.">>=
...
<<transport_GHG_emissions, fig.cap="CO$_2$ emissions from U.S.\\ transportation. ``Maritime'' is ships and boats. ``Small trucks'' are light-duty trucks. ``Large trucks'' are medium- and heavy-duty trucks. Source: **** Get source from Anjana. ****">>=
...
Vehicle efficiency %(actually, an ``efficacy'') 
is usually quantified in distance traveled per volume
of fuel consumed\index{efficiency!fuel}\index{efficiency!vehicle}.
The U.S.\ fleet-average fuel efficiency of cars and trucks has varied 
significantly over the past few decades.
(See Figure~\ref{fig:US_mpg}.)


<<US_mpg, fig.cap = "U.S.\\ car, truck, and fleet fuel efficiency. Source: \\citeauthor{Hicks:2014tn, NHTSA2019tc}~\\cite{Hicks:2014tn, NHTSA2019tc}.">>=
...
is now about midway between the average car and average truck efficiencies.
...
In addition to vehicle design, driving habits also influence fuel efficiency.
...
<<Biofuel_cons, fig.cap = "U.S.\ biofuel consumption, 1981--2020. Source: \\citeauthor{U.S.-Energy-Information-Agency:2021to}~\\cite{U.S.-Energy-Information-Agency:2021to}.">>=
