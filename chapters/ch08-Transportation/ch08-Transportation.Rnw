...
% 
% 
% <<Tonne_km, fig.cap = "U.S \\ tonne_km", fig.cap = "U.S.\ freight by transportation mode.", fig.width = 5, fig.height = 3, echo = FALSE>>=
% 
% data_string <-
...
% 
%   ggplot2::ggplot(mapping = ggplot2::aes(x = Year, y = value, fill = type)) +
%   ggplot2::geom_area() +
%   ggplot2::labs(x=ggplot2::element_blank(), y = expression("Freight transport [tonne-km]")) +
%   ggplot2::scale_x_continuous(breaks = c(1980, 1990, 2000, 2010, 2016)) +
...
% <<Passenger_km, fig.cap="U.S passenger km", fig.width = 5, fig.height = 3, echo = FALSE>>=
...
% 
% 
%   ggplot2::ggplot(mapping = ggplot2::aes(x = Year, y = value, linetype = type)) +
%   ggplot2::geom_line() +
%   ggplot2::labs(x=ggplot2::element_blank(), y = expression("Passenger kilometers in the U.S.")) +
%   ggplot2::scale_x_continuous(breaks = c(1960, 1970, 1980, 1990, 2000, 2010, 2017)) +
%   ggplot2::labs(fill = element_blank()) +
%   MKHthemes::xy_theme()
% @
...
<<TSI, fig.cap="Seasonally-adjusted transportation index data for freight, passenger, and overall services. Source: Bureau of Transportation Statistics~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}.">>=
TSI <- readxl::read_excel(file.path("chapters", "ch08-Transportation", "datasets", "Transportation_Services_Index_and_Seasonally-Adjusted_Transportation_Data.xlsx"),
  ...
  tidyr::pivot_longer(cols = c(Passenger, Freight, Overall), names_to = "indicator", values_to = "value")

TSI %>% 
  ggplot2::ggplot(mapping = ggplot2::aes_string(x = "Date", y = "value", colour = "indicator")) + 
  ggplot2::geom_line() +
  ggplot2::scale_y_continuous(limits = c(0, 150)) +
  ggplot2::scale_colour_viridis_d(end = 0.85, direction = -1) +
...
utils::read.table(text = data_string, sep = "\t", header = TRUE, stringsAsFactors = FALSE, check.names = FALSE) %>%
  ...
  ggplot2::geom_line() +
  ggplot2::labs(x = element_blank(), y = expression("Miles per gallon")) +
