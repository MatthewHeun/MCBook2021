...
(for instance, electric vehicles\index{electric vehicle (EV)} run by solar electricity)
...
including transportation efficacy, biofuels, and electric vehicles\index{electric vehicle (EV)}.
...
a fascinating movie about the the first attempt at electric vehicles\index{electric vehicle (EV)} in the auto industry.
...
\item Under the right conditions (an electricity mix that includes renewable sources
      ...
      provide GHG emissions reductions relative to internal combustion engine vehicles
