...
and climate\index{climate} change (the prime example of Part~\ref{part:IPARX})
were discussed.
...
a documentary about ``General Motors'\index{General Motors} role in dismantling street car transportation in the 1930’s, 
