...
Roy Symons's blog \emph{Transportation planning: Thoughts on how we move} \\
...
{Did GM really kill the streetcar in Los Angeles?} (YouTube, September 7, 2018)
...
\item Bicycling is one way to solve the first-mile problem\index{first-mile problem} 
      ...
      (possibly, with your bike onboard), and then bike to your final destination. 
...
\item Two ways to reduce highway congestion are 
      ...
      tolls likely involve constructing toll infrastructure and labor costs\index{labor!cost} for staffing, 
