...
\begin{figure}
\centering
\includegraphics[width=\figwidth]{chapters/ch08-Transportation/figures/Last-mile_Delivery.pdf}
\caption{Percentage of delivery cost by part of journey.}
\label{fig:last_mile}
\end{figure}
...
especially energy consumption, energy efficiency, % (really, efficacy),
and climate change (the prime example of Part~\ref{part:IPARC})
were discussed.
...
Pithy quotes and cartoons about transportation: \url{https://www.transportation-planning.com/quotes.html}

Interactive EV explainer: \url{https://ig.ft.com/electric-car/}

Who Killed the Electric Car: \url{https://en.wikipedia.org/wiki/Who_Killed_the_Electric_Car\%3F}

Road Guy Rob YouTube channel.
...
{Did GM really kill the streetcar in Los Angeles?} \emph{and} references therein,
...
\item Consider the infrastructure choice of a vehicle ferry versus a bridge. 
      ...
      such as the IPARC equation, factor into your decision-making process?
