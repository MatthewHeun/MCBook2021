...
PM ``is also the form in which most of the long-range transportation 
...
\item Research the key natural resources required to make batteries for EVs. 
      ...
      What would be the sustainability implications of transitioning all road transportation to EVs?
