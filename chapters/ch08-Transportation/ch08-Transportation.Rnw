...
For the US, of the four areas listed in Table \ref{tab:corrected_co2_emissions},
transportation has the greatest carbon emissions.
In addition, transportation contributes to the the ``carbon footpirnts'' of many 
other human activities. 
The previous chapter considered households in isolation. 
However, household location determines the need for heating and cooling.
This chapter, and the two following chapters, will consider the many ways that
...
Options for a sustainability transition are explored.
A summary concludes.
...
economic activity, 
one reason that economic energy growth are tightly linked.
