...
\item Driving has long been a competitive sport. One lesser-known form of 
      ...
      which attempts to maximize fuel efficiency
      of a stock vehicle, that is, not a purpose-built vehicle.
      Hypermiling\index{hypermiling} results in driving behaviors that are\ldots{}unorthodox, such as
...
\item Two ways to reduce highway congestion are 
      ...
      require extension of infrastructure or converting an existing lane 
