...
the last mile problem\index{last mile problem}, 
...
Another sustainability challenge for transport is 
...
The first mile problem\index{first mile problem} is reduced in urban areas with high population density, 
...
\item Bicycling is one way to solve the last mile problem\index{last mile problem} for personal travel.
