...
mineral resource depletion\index{mineral resource depletion (MRD)} 
discussed above.
...
\item Under the right conditions (an electricity mix\index{electricity mix} that includes renewable sources
      ...
      The tradeoff between GHG emissions\index{CO$_2$ emissions!tranportation}
      and mineral resource depletion\index{mineral resource depletion (MRD)} is
