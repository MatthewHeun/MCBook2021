...
<<transport_GHG_emissions, fig.cap="CO$_2$ emissions from U.S.\\ transportation. ``Maritime'' is ships and boats. ``Small trucks'' are light-duty trucks. ``Large trucks'' includes meduim- and heavy-duty trucks. Source: **** Get source from Anjana. ****">>=
...
transport_GHG %>% 
  ...
  ggplot2::labs(x = ggplot2::element_blank(), 
                ...
                # y = expression("Transport emissions"), 
                fill = ggplot2::element_blank()) +
