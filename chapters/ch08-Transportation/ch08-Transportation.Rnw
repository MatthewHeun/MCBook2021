...
<<passengerkm_by_mode, fig.cap="U.S.\\ passenger-km of personal transport by mode. Intercity is rail travel via Amtrak. Transit is public transit of all types (ferry, subway, bus, etc.). Air is U.S.\\ domestic air carriers. Highway is automobile traffic. Source: U.S. Bureau of Transportation Statistics~\\cite{passenger_km}.">>=
...
<<tonnekm_by_mode, fig.cap="Freight transport by mode, 1980--2018. ``Pipeline'' is transportation of liquids (such as fuels) through pipelines. Source: U.S.\\ Bureau of Transportation Statistics~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021vu}.">>=
...
<<TSI, fig.cap="Seasonally-adjusted transportation index data for freight, passenger, and overall transportation services. (2000 = 100) Source: U.S.\\ Bureau of Transportation Statistics~\\cite{U.S.-Department-of-Transportation-Bureau-of-Transportation-Statistics:2021uk}.">>=
...
<<commuter_percentage_by_mode, fig.cap="Percentage of U.S.\\ commutes by mode. Note: ``Taxi'' includes motorcycles and other commuting modes. Source: U.S. Bureau of Transportation Statistics \\cite{U.S.-DOT-BTS:2019ww}.">>=
...
<<US_mpg, fig.cap = "U.S.\\ car, truck, and fleet fuel efficiency. Source: U.S.\\ National Highway Traffic Safety Administration \\cite{Hicks:2014tn, NHTSA2019tc}.">>=
...
<<Biofuel_cons, fig.cap = "U.S.\ biofuel consumption, 1981--2020. Source: U.S.\\ Energy Information Agency~\\cite{U.S.-Energy-Information-Agency:2021to}.">>=
