...
\item As a preview of chapter \ref{chap:land_use_urban_planning}, there are strong
      ...
      a week for 50 weeks per year, is 500 hours of commuting. Equating 500 hours
      of travel to \$40,000 is an \$80/hour wage.
      
\item City center travel exclusion zones.

\item Stroads and unsafe by design.      
