...
\item U.S.\ president Joe Biden included funding for a Civilian Climate Corps modeled after the 
      ...
      problems, what can low-skilled manual labor accomplish toward solving the climate crisis?
      What are proposed monetary costs of the Civilian Climate Corps?
...
\item Of the three modes of action (education about the importance of sustainability,
      research to develop and improve sustainable technologies, and laws and regulations
...
\item Few would claim that today's birth-control technologies are the best
      ...
      Arguably, Equation~\ref{eq:IPARC} indicates that reducing future human population
...
\item Consider the case of a homeowner who was operating a commercial bakery in his 
      suburban garage. 
      The homeowner didn't have a business permit and the neighborhood wasn't zoned for 
      business.  
      The baker's neighbor(s) complained to city officials about all the delivery traffic
      on the street.
      Consequently the bakery was shut down.
      Is it wise to shut down bakery? 
      Why or why not? 
