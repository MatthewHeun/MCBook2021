...
as when governments employ scientists to develop models of the atmosphere. 
...
For example, one major source of ocean plastic pollution is discarded fishing nets. 
(See \ref{project:ocean_plastic}.)
An international treaty that banned discarding nets and added penalties for 
doing so could help to address the issue of ocean plastics.
