...
sustainability.
\paragraph{Governments} The first type of collective group has the power to make laws, rules, and policies.
...
\paragraph{Corporations} The second type of collective is a \emph{business corporation}. 
...
and collectives can take for sustainability but the list serves as a framework
...
\paragraph{Research} 
Research means both the creation of new knowledge and the invention or 
...
\paragraph{Education}
Education has the power to ``change hearts and minds.'' 
Disseminating information about sustainability is a crucial step in achieving a
sustainable society.
***** Say education encompasses advertising, reading books for a term paper,
etc. ****
...
**** Say more about individual choices. 
Characteristic: choosing a sustainable option from a menu of existing
activities.
****
...
the \emph{action} is either a law, research, or education 
...
Slowing or reversing population growth would reduce environmental impacts,
all other things being equal.
Table~\ref{tab:sust_sent_pop} shows example sustainability sentences
to limit population growth.

\begin{table}
\footnotesize
\centering
\caption[toc caption]{Sustainability sentences for population.}
\label{tab:sust_sent_pop}
\begin{tabular}{r l l}
\toprule
Subject & Action & Object \\ 
\midrule
Governments & provide general education & to girls and women. \\
Governments & provide family planning education & to girls and women. \\
Governments & supply birth control technology & to citizens. \\
Legislatures & pass laws & on various family planning matters. \\
Lawmakers & write family friendly policies & such as maternity leave, etc. \\
\bottomrule 
\end{tabular}
\end{table}

State and local governments are the entity in the U.S.\
and around the world with the responsibility for providing education. 
As such, education for family planning can be done by governments.
Providing general education to citizens, especially girls and women, 
is a seemingly effective way to reduce birthrates, slow population growth, and
reduce family size.
Governments can provide 
specific education around family planning and birth control
to citizens, especially girls and women, 
to reduce population growth. 
Governments can supply birth control technology
(oral contraceptives, symptom-thermal training, condoms, etc.)
to citizens
to reduce population expansion.
Legislatures can
pass laws
