...
\caption{An Energy Guide label showing the AFUE on a domestic furnace. 
This furnace has the lowest legally allowed AFUE for its climate zone.
The U.S. Federal Trade Commission (FTC) requires a standardized label on some categories
of consumer products.
Manufactures are required to test their products in accordance with U.S. Department
of Energy standards and report their results to the FTC.
The U.S. Environmental Protection Agency runs the Energy Star program.
If a product qualifies for Energy Star, that is shown on its Energy Guide
label as well. 
...
(Figure~\ref{fig:energy_star} shows an Energy Guide label on a furnace.)
...
\begin{figure}
     ...
     \end{subfigure}
        \caption{Differences in roadway densities. 
                 ...
                 emit CO$_2$. 
                 Note that efficiency for all vehicles increases with more passengers.}
