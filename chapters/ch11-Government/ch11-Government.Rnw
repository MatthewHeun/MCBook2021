...
non-localized air pollution\index{pollution!air}, and greenhouse-gas pollution), 
...
governments can establish greenhouse gas trading markets
...
\item Carbon emissions from combustion of fossil fuels\index{CO$_2$ emissions!as negative externality}
      ...
      greenhouse gases from the atmosphere\index{atmosphere}. \label{question:carbon_tax_11}
