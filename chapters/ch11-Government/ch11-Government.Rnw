...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        \caption{An Energy Guide label showing the AFUE on a domestic furnace. 
                 ...
                 Manufactures are required to test their products in accordance
                 with U.S. Department of Energy standards and 
                 report their results to the FTC.
                 ...
                 label as well. 
                 In contrast to the Energy Guide labels, 
                 which are self-reported, since 2011, 
