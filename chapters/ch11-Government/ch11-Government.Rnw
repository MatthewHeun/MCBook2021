...
\begin{itemize}
  ...
  \item Good news: there are many options for collective action to become more sustainable. 
        But that makes it impossible to describe all options in lots of detail. 
  
  \item List of collective actions is presented mostly without comment. 
        The goal is to provide pointers to ways to actively promote sustainability.
...
%++++++++++++++++++++++++++++++
\subsection{Carbon intensity of energy}
\label{sec:collective_carbon_intensity}
%++++++++++++++++++++++++++++++
