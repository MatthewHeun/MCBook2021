...
Slowing or reversing population growth would reduce environmental impacts,
all other things being equal.
State and local governments are the entity (SUBJECT) in the U.S.\
and around the world with the responsibility for providing education (ACTION). 
Providing general education to citizens (OBJECT), especially girls and women, 
is a seemingly effective way to reduce birthrates, slow population growth, and
reduce family size.
Governments (SUBJECT) can provide 
specific education around family planning and birth control (ACTION) 
to citizens (OBJECT), especially girls and women, 
to reduce population growth. 
Governments (SUBJECT) can supply birth control technology (ACTION)
(oral contraceptives, symptom-thermal training, condoms, etc.)
to citizens (OBJECT)
to reduce population expansion.
Legislatures (SUBJECT) can
pass laws (ACTION)
on number of children, incentives for having children, 
tax breaks for raising children, or direct payments to children (OBJECTS) 
to affect the number of children per person,
often with unintended consequences. 
Lawmakers (SUBJECT) can also 
write family friendly policies and programs (ACTION) such as 
generous maternity leave, early childhood education and daycare, 
health insurance, and subsidized college tuition (OBJECTS)
