...
\captionsetup[subfigure]{justification=centering}
     ...
     \begin{subfigure}[b]{0.31\textwidth}
         ...
         \caption{Energy Star freezer Energy Guide.}
...
Figure~\ref{fig:energy_star} shows three different energy labels for two home 
...
\item In a 1976 referendum, voters in Michigan approved the U.S.'s best 
      ...
      In part because of the high deposit, Michigan's bottles are cans have a very
      ...
      Should the program be expanded to other beverage containers (say bottled water, for instance)?
