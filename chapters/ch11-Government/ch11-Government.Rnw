...
improved windows.
Municipalities can mandate installation of solar systems 
...
These collective actions are encouraged by several 
...
The living building challenge encourages 
...
PACE financing \href{https://www.pacenation.org}{PACENation}

\href{https://living-future.org/lbc/}{Living Building Challenge}
}
...
\item Who, in your view, is the government? 
      There can be a spectrum from ``we are all the government. 
      The government is a mechanism for collective action''
