...
% Matt, check the following two paragraphs.
...
The net result reduces total energy savings across the economy and, in some cases,
actually \emph{increases} total energy consumption.
...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        ...
        models'' to compare to, that is around 12.9 cubic feet is an uncommon size.
        ...
        The EnerGuide label is mandatory for appliance sold in Canada, which also
...
middle-of-the-road.
Clearly, if the point of the labels is to be clear and easy to understand, there
