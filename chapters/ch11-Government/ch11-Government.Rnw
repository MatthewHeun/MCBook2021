...
For this chapter on collective actions, 
the good news is that there are many 
ways to change the rules of the game to make 
society as a whole more sustainable.  
Our lists of collective actions are organized first 
by the $PARC$ terms (Chapters~\ref{chap:population}--\ref{chap:carbon_intensity})
...
The goal of this this chapter and the next is to provide references to 
ways to actively promote sustainability.
Readers are encouraged to explore the suggested actions that fit their
local situation, always keeping the global perspective provided 
