...
\item Carbon emissions from burning fossil fuels create negative externalities. 
      (You burning fossil fuels hurts me. That's a ``cost'' I pay but you don't.)
      Would it be more \emph{effective} to address the negative externalities 
      of fossil fuel consumption with a 
      supplementary tax on fossil fuels \emph{or} via remediation of externalities
      by individuals and NGOs? 
      Taxes will create incentives to move away from fossil fuels.
