...
society and individuals can take to live more sustainably.
Chapter \ref{chap:government} explores collective actions and 
Chapter \ref{chap:personal_action} explores personal or individual actions.
% Collective actions are taken because they're "too big" for an individual.
% Actions (3) = Education/dissemination/"change hearts and minds", Research/Tech, Laws/rules/standards/"rules of the game."
% Actors ($) = Individuals, Voluntary groups (prof. societies, NGOs, civic groups), Corporations, Governments.
% z-axis?
% Collective action success stories = Montreal protocol banning CFCs. Clean Water Act.
Collective actions may involve changing the rules of the game 
or providing widespread incentives
to encourage self-interested individuals
to become more sustainable.
Or, collective actions can be a voluntary pooling of skills or resources.
Collective actions can be taken by
national governments, 
international organizations (United Nations, World Bank, \ldots), and
non-governmental organizations (Red Cross, Oxfam, \ldots).
...
Of the three entities mentioned above 
(governments, international organizations, and non-governmental organizations)
governments set the laws and regulations that organize societies.
They create the ``rules of the game.''
...
they affect those relationships on many levels.
...
In some cases, laws and regulations define what citizens and corporations cannot do.  
(E.g., some types of pollution are regulated.)
In other cases, laws and regulations define what must be done.
(E.g., renewable energy portfolio standards mandate that a certain percentage 
...
(E.g., regulations can establish markets for carbon trading.)

The rules of the game are exceedingly important for the environment, because
unintended environmental consequences often emerge from
...
ways to shape the rules of the game to make 
society as a whole more sustainable.  
In the remainder of this chapter, we provide lists 
of collective actions to make societies more sustainable,
organized first by
...
Each section below provides lists of possible collective actions, 
mostly without comment. 
The lists are self-consciously incomplete. 
(How could the be otherwise?)
The goal is to suggest collective actions that will be generative; these examples
should help readers think of many other ideas.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{$PARC$ terms}
\label{sec:collective_parc_terms}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
As shown in Equation~\ref{eq:IPARC}
...
Equation~\ref{eq:IPARC} and Figure~\ref{fig:AffluenceGraph-Nordhaus}
...
Equation~\ref{eq:IPARC} shows that
...
(See Equation \ref{eq:IPARC_rate_with_numbers}.)
...
hyper-recycling can be implemented. 
...
\label{sec:collective_contamination_intensity}
%++++++++++++++++++++++++++++++

Equation~\ref{eq:IPARC} shows that reducing 
the contamination intensity of resources ($C$)
will cause environmental impacts ($I$) to decline.
One way to reduce the contamination intensity of resources ($C$)
...
\label{sec:collective_sustainability_challenge_areas}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\captionsetup[subfigure]{justification=centering}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         \centering
           \includegraphics[width=\linewidth]{chapters/ch11-Government/photos/I-196.jpeg}
     ...
     \end{subfigure}
        \caption{Differences in roadway densities. 
                 The highway interchange has few passengers in low-occupancy vehicles, 
                 all with high CO$_2$ emissions. 
                 In contrast, the bus depot has more passengers 
                 in high-occupancy vehicles, 
                 an efficiency gain, even if the buses in the photo
                 emit CO$_2$. 
...
\captionsetup[subfigure]{justification=centering}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         ...
         \caption{Suburban grocery store. **** Need photo.}
...
% How can education/training help? 
% How can legal structures help? 
% How can standards/information help?
...
\noindent Vlog Brothers \href{https://www.youtube.com/watch?v=wcMLFMsIVis}{``How we fix the climate''}
...
\item The U.S.\ president is proposing a Civilian Climate Corps modeled after the 
      ...
      What is the cost of such a program (monetary and non-monetary)?
      
\item Of the three modes of action (education about the importance of sustainability,
      research to improve sustainable technologies, and laws and regulations
      requiring sustainability) which is the most important? 
...
\item Money is the mechanism that we use to value economic transactions. 
      What might be an analogous denomination for environmental or social value?
      Can all environmental and social values be converted to monetary equivalents?
...
\item No one is arguing that the birth-control technology we have now is the best
      of all possible birth-control technologies.
      A better birth control would be cheaper, more effective, and easier to use.
      Arguably, looking at Equation~\ref{eq:IPARC} reducing future human population
      is the most effective thing we can do for sustainability.
      Who should have responsibility for developing next generation birth-control
      technology, government(s), corporations, nonprofits, or an individual?
...
\item Carbon emissions from burning fossil fuels create externalities. 
      ...
      Would it be more \emph{effective} to address this externality with a 
      supplementary tax on fossil fuels \emph{or} is remediation of externalities
      better left to individuals and NGOs? 
      ...
      to reduce the effects of climate change or to technology that coudl remove 
...
\item Some people lament that we can't seem to get effective government action
      ...
      participation, maybe by setting up an NGO.
      2) Work within the government to change its approach, perhaps by lobbying or
      campaigning for different elected officials.
      ...
      we might attempt to change campaign-finance laws to deny them influence.
...
\item In the U.S., restaurant wait staff are paid below minimum wage on the
      ...
      Why or why not? Is flying different than eating in a restaurant? Explain your answer(s).
...
\item In a 1976 referendum, voters in Michigan approved the U.S.'s best 
      ...
      10-cent deposit; their rate increased to 10 cents from 5 cents in 2017.)
...
\item The expansion of PACE financing into the residential market has created
      ...
      people for loans they don't need and/or can't understand.
      ...
      If so, who leads the charge and what is the remedy?
...
\item Businesses are an important part of an alternative transportation infrastructure.
      ...
      Laws are also part of infrastructure.
      Discuss some of the nonphysical infrastructure missing from today's transportation
      landscape. 
      Consider at least laws governing autonomous vehicles, whether stiffer penalties
...
\item Some states adopt ``right to farm'' laws in response to urban development 
      ...
      The idea is that you can't build a house next to my farm and then sue me
      when you don't like the smell of goats.
      At the other end of the spectrum are horror stories of over-zealous homeowners
      associations police (and prosecute) real or perceived violations of suburban
      lawn-care norms.
      Should there be a right to ... garden? 
      Can I have chickens and goats in my yard? Under what circumstances?
      Or, do zoning laws have their place? 
      At what point should a garden be considered a farm?

\item Consider the case of a guy who was operating a commercial bakery in his 
      suburban garage. 
      He didn't have a business permit and his neighborhood wasn't zoned for 
      business.  
      His neighbor(s) complained to city officials about all the delivery traffic
      on the street.
      Consequently the bakery was shut down.
...
\item Craft a research proposal to scope the magnitude of a tax on fossil fuels to 
      ...
      (as discussed in Q11.\ref{question:carbon_tax_11}.
      How large should the tax be?
      What things should you consider?
      What is known about this topic already?
      What are the gaps in knowledge?
      
\item Make a business plan to increase bike commuting or other alternative 
      (to automobile) transportation in your community.
