...
action, and object.
The subject can be an individual doing the action or a collective.
...
Characteristically, businesses are \emph{engaged in commercial activity}, 
that is, making or selling a product or service.
...
This book will consider four archetypal actions for sustainability:
\begin{itemize}
\item Choices
\item Laws
\item Research
...
and collectives can take for sustainability but the list serves as a \emph{framework}
...
sustainability and that involves choosing a sustainable option from a menu of existing
...
Not all R\&D activities meet the definition of the research action; for the purposes
of this book it has to be sustainability related. 
...
\paragraph{Government+Law+Contamination}
...
\paragraph{Corporations+Research+Contamination}
...
\captionsetup[subfigure]{justification=centering}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         ...
         \caption{Suburban grocery store. **** Update photo.}
...
ecosystem services (Government + Choice + Land use).
...
preserve valuable biomes (Government + Law + Land use).
...
\paragraph{Government/Organization+Research+Land use}
...
\paragraph{Government+Law+Urban planning}
