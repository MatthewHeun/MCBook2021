...
On the other hand, research would give you more information about menu items.
To stretch the metaphor a little more, research might tell you that trace amounts
of mercury in your tuna salad can have neurological effects.
This doesn't change the price on the menu (in dollars) but it might influence
