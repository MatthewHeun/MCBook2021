...
Air-Conditioning Engineers (ASHRAE),  the 3$^{\text{rd}}$ Generation Partnership Project (3GPP),
...
For instance, banning synthetic fibers in clothes to prevent microplastic pollution\index{pollution!microplastic}
...
\item Some states adopt ``right to farm'' laws in response to urban development 
      ...
      lawn-care norms.
      Should there be a right to\ldots{}garden? To line dry clothes?
