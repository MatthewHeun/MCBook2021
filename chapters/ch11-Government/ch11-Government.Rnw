...
mostly applied to electricity, not liquid fuels.
...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        \caption[Consumer-oriented labels for home appliances]
                ...
                expected cost of yearly operation and estimated yearly electricity 
...
renewable mandates for electricity producers.
