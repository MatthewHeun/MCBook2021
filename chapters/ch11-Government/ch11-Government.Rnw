...
However, the rebound effect\index{rebound effect} and energy-efficiency\index{energy efficiency} backfire can 
counteract energy efficiency\index{energy efficiency} measures;
...
To reduce rebound\index{rebound effect} or backfire, 
