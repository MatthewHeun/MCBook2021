...
\paragraph{Collective} Actions for sustainability can be taken by individuals
or by groups. 
This chapter will consider several types of groups that might take actions for 
sustainability.
The first type of collective group has the power to make laws, rules, and policies.
We call this type \emph{governments}.
...
The second type of collective is a \emph{business corporation}. 
Examples of corporations include Volkswagen, Siemens Gamesa Renewable Energy,
Saudi Arabian Oil Company, Maersk, and Best Buy.
Characteristically, businesses are engaged in commercial activity, either making 
...
an \emph{organization}.
Example organizations include the American Society of Heating, Refrigerating and 
Air-Conditioning Engineers (ASHRAE),  local churches, the Internet Society, political
...
Collectives can sometimes straddle the boundaries between the above categories.
For instance, the Federal National Mortgage Association (``Fannie Mae'') is part
U.S. government, part business corporation.
...
including Catholic Relief Services, and organizations, including local churches.
Another example is the National Audubon Society, is a company that is affiliated with
...
%^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Despite some ``fuzziness'' in the definitions of the different types of collectives
the categories are useful as a framework to help us think about the capabilities
of collectives. Not all collectives are equally suited for or adept at the same tasks.
\end{mcframe}

\paragraph{Actions} 
Collective actions are taken because they are ``too big'' for an individual.
Many times they require the cooperation of other people to be successful.
This book will consider three types of collective actions:
\begin{itemize}
\item Laws
\item Research
\item Education
\end{itemize}
The \emph{actions} listed above are not an exhaustive list of actions that individuals
and collectives can take for sustainability but the above list serves as a framework
...
Often the purpose of these regulations is to internalize externalities.
...
\emph{Research} means both the creation of new knowledge and the invention or 
development of new technology.
For instance, forest and wildlife managers may wish to know how climate change is
changing the range of the mountain pine beetle, which affects whitebark pine and 
grizzly bear populations.
Or, a company may develop better designs for electric motors, batteries, or 
wind-turbine blades.

\emph{Education} has the power to ``change hearts and minds.'' 
