...
biofuels with a very low EROI\index{energy return on investment (EROI)}; see Table~\ref{tab:eroi}. 
Figure~\ref{fig:E85} shows a commercially available biofuel blend with low EROI\index{energy return on investment (EROI)}.
