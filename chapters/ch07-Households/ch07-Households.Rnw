...
This is the first of six chapters to discuss
economic sectors and areas of life 
where sustainability challenges are relevant:
households (this chapter),
transportation (Chapter~\ref{chap:transportation}), 
agriculture (Chapter~\ref{chap:agriculture}), 
land use and urban planning (Chapter~\ref{chap:land_use_urban_planning}), and
government (Chapter~\ref{chap:government}).
A summary of sustainability-friendly personal actions 
is provided in Chapter~\ref{chap:personal_action}.
This chapter focuses on households.
...
\begin{figure}
\centering
\includegraphics[width=\figwidth]{chapters/ch07-Households/figures/Energy_US_2020.png}
\caption{U.S.\ energy consumption 2020.}
...
Chapter~\ref{chap:personal_action} makes concrete suggestions
