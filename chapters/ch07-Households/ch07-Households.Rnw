...
11.5~quads of energy are consumed in U.S.\ residences%
\footnote{
A quad is 1 short quadrillion BTUs, or $10^{15}$~BTU.
},
%
predominantly electricity and natural gas.\index{electricity!consumption!households}
This 11.5~quads represents 16\% of final energy consumption.
...
Some people (physical plant employees, custodial staff, or supervisors)
operate buildings and machines
that consume energy, raw materials, and other resources.
Such leaders make decisions every day that have sustainability implications.
...
However, every ordinary person makes decisions with sustainability implications
in their own household.

Figure~\ref{fig:average_residential_energy} shows how the average U.S.\ resident
allocates their energy consumption\index{energy consumption!residential}
...
energy and water (Chapter~\ref{chap:resource_intensity}) and 
