...
%add citations to Millennium Ecosystem Assessment and The Common International Classification of Ecosystem Services
...
Climate scientists have proposed (e.g., \cite{Rockstrom2009})
%eight 
indicators, which, if exceeded, could render Earth uninhabitable by humans, 
...
species, see Chapter \ref{chap:population}).
