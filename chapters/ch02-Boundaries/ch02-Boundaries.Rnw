...
<<CO2Graph, echo=FALSE, fig.cap="Atmospheric CO$_2$ concentration over time. Vertical line shows the year 2020.">>=
...
readxl::read_excel(file.path("chapters", "ch02-Boundaries", "datasets", "AtmosphericCO2vsTime.xlsx"), sheet = "data to plot") %>% 
  ...
  ggplot2::geom_vline(xintercept = -2.2, size = 0.2) +
  ggplot2::geom_line() + 
  
  ggplot2::scale_x_reverse() +
  
  # Eliminate "Year" label on x axis.
  ggplot2::labs(x = "Year [thousands BCE]", 
