...
Thus, the entire agricultural system can be characterized by an efficiency 
as a ratio of kcal of food output divided by kcal of feed input.
...
as shown in Figure~\ref{fig:feed_to_food}.
