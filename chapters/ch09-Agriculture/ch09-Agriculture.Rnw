...
The intensity of agriculture, in terms of what inputs it requires and what 
...
Section~\ref{sec:what_is_sustainability} says sustainability requires not using renewable resources
faster than they can regenerate. 
Soil fertility is a provisioning services (Chapter~\ref{chap:planetary_boundaries})
of the  ecosystem.
...
%..............................
Not all soils contain the nutrients needed by plants to grow.
...
Soil fertility can be degraded by practices that withdraw key nutrients from the 
...
(Foods with low feed-to-food efficiency tend to have higher greenhouse gas emissions;
...
paint a suggestive (but incomplete!) picture of agricultural
CO$_2$ emissions.

\paragraph{CH$_4$}
Add stuff about cattle here.
Methane is 25x as powerful a GHG as CO2.
But it's not the cattle, it's the agricultural practices.
And we need animals for regenerative agriculture.
...
water from the environment greater than their regeneration rates.
