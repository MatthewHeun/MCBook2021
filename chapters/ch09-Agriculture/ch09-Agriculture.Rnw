...
paint a suggestive 
(but incomplete! ***why incomplete?*** 
**** I don't think I wrote ``incomplete.''
OK by me to delete this parenthetical phrase. ---MKH ****) 
...
One tonne of methane has the same global-warming potential as twenty five tonnes of CO$_2$;
methane is a very potent GHG.
...
water from the environment at rates greater than their 
...
\item Retail is an important part of the food supply chain.
      ...
      *** I'm suggesting that this should be a project. ***
