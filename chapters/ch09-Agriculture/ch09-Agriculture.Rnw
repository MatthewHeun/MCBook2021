...
the energy used in the United States and 44\% of US CO$_2$ emissions. 
...
not contribute (as much) to an overall framework for sustainability.
...
Furthermore, agriculture has strong links to Chapter \ref{chap:land_use_urban_planning},
land use.
...
Food is a source energy for humans to pursue lives of work, service, and play
...
wood, cellulose, sunlight, or petroleum.

\section{Food demand}
Food consumption is rather predictable, because food energy intake (measured in 
food calories) scales linearly with population. 
Over a long period of time, at least since 1870 when such thing began to be 
measured to today, the amount people eat, in pounds of food per day, 
has been relatively constant.
There is a fundamental, biological limit to the amount our bellies can hold.
In the U.S., there has been about a modest (22\%) increase in calories consumed 
...
Rising affluence (Figure~\ref{fig:AffluenceGraph-Maddison}) means there are lots
of things we could (and would) do without before we would give up food.
(The share of wealth spent on food goes down as affluence rises; food becomes
relatively cheaper as economies develop.)
Lastly, Section~\ref{sec:malthus_erlich_simon} suggests humanity will continue to
have resources for food production.
(Despite the fact that hunger continues to be an issue in the world today, food
...
The efficiency of agriculture, what inputs it requires and what impacts it produces
are explored more in the following sections.


\subsection{cool food facts}
It takes 10 units of energy (mostly fossil fuel) to produce one unit of food energy.
Caloric intake has increased 20\% since the 1970s but generally food per person is
constant. We don't store food (or really anything else in the global supply chain).
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch09-Agriculture/figures/Food_Desert.pdf}
