...
\paragraph{Energy} \label{sec:food_energy_return_ratios}
...
\label{fig:GHG_food_old}
\end{figure}



<<GHG_food, fig.height=5, fig.cap="Food greenhouse gas emissions. Source: Heller and Keoleian~\\citep[Figure~3]{Heller_2014}.">>=
