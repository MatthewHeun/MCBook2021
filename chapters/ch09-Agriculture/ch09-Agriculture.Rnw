...
<<food_and_ag_material_flow>>=
ag_sankey <- readxl::read_excel(file.path("chapters", "ch09-Agriculture", "datasets", "Ag Sankey.xlsx"),
                                sheet = "data to plot")
...
ag_sankey %>% 
  ...
  ggsankey::geom_sankey_label(size = 2, color = "white", fill = "gray40") +
