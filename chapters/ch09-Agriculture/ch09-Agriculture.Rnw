...
Whether getting food in this way is sustainable or not depends on where our energy
comes from. 
...
neighbors.
However, the most globally important form of air emissions is of greenhouse 
...
\paragraph{Soil} The main impact of agriculture on soil is erosion.
