...
The next section explores the sustainability challenges in agriculture, which arise
...
<<food_and_ag_energy_flow, fig.scap="Energy consumed in the food-delivery system", fig.cap="Amount of energy consumed in different aspects of the food-delivery system in the U.S.\\ (2021). \\emph{Source}: \\citet{US_food}.">>=
...
<<FoodToFeedEfficiency, fig.width=3, fig.height=2.5, fig.scap="Feed-to-food efficiency", fig.cap="Feed-to-food efficiency~($\\eta_{\\mft{ff}}$\\;\\!) of various foods in the U.S.\\ food system. \\emph{Source}: \\citet{Shepon:2016wt}.">>=
...
<<food_ghg, fig.scap="Food-related greenhouse gas emissions by life cycle stage", fig.cap="U.S.\\ food-related greenhouse gas emissions by life cycle stage. ``LULUC'' is land use and land use change. \\emph{Source}: \\citet{Crippa:2021tp}.">>=
...
<<FoodEmissionsPerMcal, fig.height=4, fig.scap="Food CO$_2$ emissions per Mcal of food", fig.cap="Food CO$_2$ emissions per Mcal of food. \\emph{Source}: \\citet{Ritchie:2021tl}.">>=
...
<<GHG_food, fig.height=5, fig.scap="Food greenhouse gas emissions", fig.cap="U.S.\\ food greenhouse gas emissions. \\emph{Source}: \\citet[Figure~3]{Heller_2014}.">>=
