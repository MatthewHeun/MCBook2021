...
with an estimated 12\% of global ice-free land being used for crops, 37\% for pasture,
and 22\% as forests for timber production~\cite{SRCCL2019}.

Agriculture provides non-food products such as cotton, flax (for linen), flowers,
and leather as well as food.
However, this chapter will mostly focus on food products because humans cannot 
live without it.
...
Over a long period of time, 1870 to today, the amount people eat, in pounds of 
food per day, has been relatively constant.
In calories per day, there has been about a 22\% increase in the U.S. since 
1967~\cite{Gordon2016}.
