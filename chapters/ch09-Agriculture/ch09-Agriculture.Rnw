...
<<FoodToFeedEfficiency, fig.width=3, fig.height=2.5, fig.cap="Feed-to-food efficiency~($\\eta_{\\mft{ff}}$\\;\\!) of various foods in the U.S.\\ food system. \\emph{Source}: \\citet{Shepon:2016wt}.">>=
...
<<FoodEmissionsPerMcal, fig.height=4, fig.cap="Food CO$_2$ emissions per Mcal of food. \\emph{Source}: \\citet{Ritchie:2021tl}.">>=
...
\caption[Material flow in the U.S.\ food system (1995, flows in million pounds.)]{Material flow in the U.S.\ food system (1995). Flows in million pounds. \emph{Source}: \citet[Figure~3]{Heller:2000wg}. Used with permission.}
