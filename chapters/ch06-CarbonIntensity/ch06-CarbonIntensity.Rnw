...
\begin{projects}
  ...
  \item Should we manage our energy transition or should we let economics do it f
        or us?
  ...
  \item **** What are the other resource implications of a WWS transition? Do we have enough Nyobium 
        for wind turbines? 
