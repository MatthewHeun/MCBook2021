...
That said, there are at least two often-discussed options for
...
namely exclusive use of traditional biofuels (wood and wood products).
(See Figure~\ref{fig:PrimaryEnergyGraph}.)
However, supplying the energy needs of today's economy would be impossible:
we don't have enough available land area to grow the required amount of crops for biomass purposes.
Further, biomass by itself does not provide electricity.
...
Nor does biomass provide liquid fuels for transportation.
The world's liquid fuel production infrastructure would require a complete overhaul.
...
energy sources.
However, in addition to transitioning to WWS,
reducing the carbon intensity of energy will require
