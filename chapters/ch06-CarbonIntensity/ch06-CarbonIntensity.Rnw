...
r_I_check <- r_P_220 + r_A_220 + r_R_220 + r_C_220

stopifnot(abs(r_I_check - r_I_220) < 0.0005)
@
...
$r_I$                       & $\approx$ & $r_P$                       & $+$ & $r_A$                       & 
                                    $+$ & $r_R$                       & $+$ & $r_X$                         \\
\Sexpr{rate_to_string(r_I_220)} & $\approx$ & \Sexpr{rate_to_string(r_P_220)} & $+$ & \Sexpr{rate_to_string(r_A_220)} &
