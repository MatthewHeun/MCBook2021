...
\caption{U.S.\ CO$_2$ emissions in 2018.
         ...
         Source: \citeauthor{Lawrence-Livermore-National-Laboratory:ua}~\cite{Lawrence-Livermore-National-Laboratory:wp}.}
...
The thinking goes that either the resource intensity ($R$ in the IPARC identity) 
or contamination intensity ($C$ in the IPARC identity), or both,
will go down.
