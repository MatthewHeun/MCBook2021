...
The final term in Equation~\ref{eq:IPARC} is 
contamination intensity of of resource consumption ($c$).
The value of $c$ represents the amount of environmental contamination
per unit of resource consumption.

Examples of $c$ includes the amount of PFAS emitted 
