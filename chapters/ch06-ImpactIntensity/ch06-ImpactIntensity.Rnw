...
(\Xparen{} in Equation~\ref{eq:IPARX}) is CO$_2$ emissions.
...
On the other hand, use of traditional biofuels resulted in deforestation, erosion,
...
The transition away from their use resulted in cleaner urban air (especially after 
...
in reduced environmental impact (at least before climate change became a concern).
...
(d) carbon tax; *** MKH to add paragraph ***
(e) biomass; and
...
Carbon offsets are a way to enable carbon emitters to %% Like a tax here??
%% Like a tax, carbon offsets change net emissions by ...? His comment doesn't seem to fit to me.
% If you can make sense of it, great otherwise, skip.
% Or maybe connect to your new carbon tax section.
...
% 1) It would be easy to revise this sentence to note that 
% “like a tax, offsets” will nudge behaviors.  
% The two systems are identical in their effect on behavior of consumers.  
% 2) Some researchers question whether offsets actually lead to offsetting carbon reductions. 
% That is, the data suggest that in the counterfactual world you’d have largely the same carbon capture. 
% (Eg, the amount of forests doesn’t rise; I just get paid for a forest that would have been there either way.) 
