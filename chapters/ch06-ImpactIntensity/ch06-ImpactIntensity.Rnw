...
<<ImpactIntensityGraph, fig.scap="Carbon intensity of primary energy~\\XCOtwoparen{} vs.\\ time", fig.cap="Carbon intensity of primary energy~\\XCOtwoparen{}. The line represents the ratio of the line in Figure~\\ref{fig:CarbonEmissionsGraph} and the top of Figure~\\ref{fig:PrimaryEnergyGraph} in each year.">>=
...
Carbon taxes impose financial penalties on emitters of greenhouse gases.
...
the topic of \ref{question:nuclear_resources}.
...
to the energy mix used in the first half of the 19$^\mathrm{\text{th}}$ century,
...
(Proof of this statement is left for \ref{item:biofuel_proof}.)
...
\begin{projects}
  ...
  \item \label{question:iparx_calcs}
  ...
  \item At the end of Chapter~\ref{chap:impact_intensity}, you have learned about all four 
        ...
        Next look into the
        \href{https://www.climateinteractive.org/tools/en-roads/}{EnROADS climate change solutions simulator}
