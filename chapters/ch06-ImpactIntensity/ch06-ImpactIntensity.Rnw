...
lowers the net EROI of fossil energy production; see Section~\ref{sec:masterE}.
...
The EROI for fossil fuels is mostly greater than 20, while
...
\begin{projects}
  ...
  \item Research and rank the EROI of many primary energy sources, 
        ...
        around which they calculated EROI.
