...
however, that $\mft{R}_{\!\mft{Ep}}$ is falling over time primarily because
...
$\mft{R}_{\!\mft{Ep}}$ is a type of economic intensity
...
It certainly helps, as decreasing $\mft{R}_{\!\mft{Ep}}$
puts downward pressure on \mft{I} in Equation~\ref{eq:IPARX}.
However, recent research indicates that growing energy efficiency
(and declining $\mft{R}_{\!\mft{Ep}}$)
...
\begin{projects}
  ...
  \item Verify the calculations in Equation~\ref{eq:IPARX_rate_with_numbers}
        ...
        of Equation~\ref{eq:IPARX_rate_with_numbers}? \label{question:iparx_calcs}
