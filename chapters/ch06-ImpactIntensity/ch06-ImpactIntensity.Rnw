...
Whether energy efficiency actually saves energy and actually reduces CO$_2$ emissions
...
(decreasing \REp{},
brought about by rising energy efficiency)
...
However, recent research indicates that rising energy efficiency
(and declining~\REp{})
...
energy efficiency alone will be unlikely to decouple environmental impacts
...
\begin{projects}
  ...
  \item Section~\ref{sec:rebound_effect} discusses the rebound effect,
        wherein monetary savings from energy efficiency are spent elsewhere in the economy,
        ...
        Green revolving fund assets must be invested in further energy efficiency,
