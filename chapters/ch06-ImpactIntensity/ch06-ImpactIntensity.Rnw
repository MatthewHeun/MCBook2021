...
is a function of $R$ (resource extraction and consumption) discussed in 
Chapter~\ref{chap:resource_intensity} in that the 
type and intensity of environmental impacts is directly related to 
the types, quantities, and ways of processing of resources. 
...
\begin{equation}\label{eq:X}
  X = \frac{\textrm{total environmental impacts produced}}{\textrm{total resources extracted}} \; .
\end{equation}
%
...
specific examples of environmental impacts caused by resource extraction and consumption include:
%
\begin{itemize}

  \item Air, water, and soil pollution~\cite{Lee:2017ui} (environmental impact) in the form of
  ...
  \item Toxic tailings (environmental impact)
  ...
  \item Deforestation\index{deforestation} and
        reduced forest quality~\cite{Kissinger:2020ut} (environmental impact)
...
Historically, as GDP (equal to $P \times A$ in Equation~\ref{eq:IPARX}) increases, 
...
however, that $R$ is falling over time primarily because
...
$R$ is a type of economic intensity
...
(decreasing $R$, brought about by rising energy efficiency)
to reduce environmental impacts ($I$ in Equation~\ref{eq:IPARX}, 
CO$_2$ emissions being the prime example)?
It certainly helps, as decreasing $R$ puts downward pressure on $I$ in Equation~\ref{eq:IPARX}.
However, recent research indicates that growing energy efficiency
(and declining $R$) has never reduced energy consumption or environmental impacts, 
...
After many years of studying energy-economy interactions and the rebound effect, 
...
As Sorrell's propositions suggest, 
