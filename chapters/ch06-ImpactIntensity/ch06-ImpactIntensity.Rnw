...
\begin{projects}
  ...
  \item After many years of studying energy-economy interactions and the rebound effect, 
        ...
        \begin{enumerate} [label=(\arabic*)]
          ...
          \item the rebound effects from energy efficiency\index{energy efficiency} improvements are significant 
  ...
  \item Section~\ref{sec:rebound_effect} discusses the rebound effect,
        ...
        Green revolving funds~(GRFs) are thought to be a way to mitigate the rebound effect.
