...
$y$ is one of \mft{I}, \mft{P}, $A$, $R$, or $X$, 
...
I.e., an increase in $A$ leads to a decrease in the rate of growth of \mft{P}.
...
It certainly helps, as decreasing $R$ puts downward pressure on \mft{I} in Equation~\ref{eq:IPARX}.
