...
the environmental impacts of resource extraction and consumption~\Xparen{}, 
...
other examples of environmental impacts caused by resource extraction and consumption include:
%
\begin{itemize}
...
our prime example for resource extraction and consumption is energy.
