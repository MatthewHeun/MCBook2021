...
\caption[U.S.\ CO$_2$ emissions Sankey diagram]
        {U.S.\ CO$_2$ emissions\index{CO$_2$ emissions!residential}
...
print(xtable::xtable(US_CO2_by_sector, digits = c(0, 0, 0, 1),
                     caption = c("U.S.\ CO$_2$ emissions by sector (2018) with
...
In some ways (but not in terms of CO$_2$ emissions and climate change\index{climate change}),
...
with respect to the prime example of energy and CO$_2$ emissions.
...
Rather, CCS is a way to avoid carbon emissions from carbon-based energy production.

There are several challenges associated with CCS.
First, it has not been cost-effective.  
Petra Nova\index{Petra Nova}, the only CCS plant in the U.S., disposed of the CO$_2$ it captured
...
significant CO$_2$ emissions will result from the transition to nuclear electricity.
...
in the right-side terms for the prime example of energy and CO$_2$ emissions
...
putting downward pressure on the CO$_2$ emissions growth rate (\rateICOtwo{}).
...
Energy efficiency\index{energy efficiency} is widely seen as a means of reducing CO$_2$ emissions.
...
Whether energy efficiency\index{energy efficiency} actually saves energy and actually reduces CO$_2$ emissions
...
environmental impacts~\Iparen{} or CO$_2$ emissions (\;\!\XCOtwo{} in the prime example).
...
For the prime example of energy and CO$_2$ emissions, 
the carbon intensity of primary energy\index{carbon intensity of primary energy}~\XCOtwoparen{} 
quantifies the CO$_2$ emissions from consuming energy.
...
\begin{projects}
  ...
  \item Section~\ref{sec:rebound_effect} discusses the rebound effect\index{rebound effect},
        ...
        (reduced energy consumption and CO$_2$ emissions)
