...
is the carbon intensity of primary energy~\XCOtwoparen{},
...
<<ImpactIntensityGraph, fig.scap="Carbon intensity of primary energy~\\XCOtwoparen{} vs.\\ time", fig.cap="Carbon intensity of primary energy~\\XCOtwoparen{}. \\emph{Source}: own calculations. The line represents the ratio of the line in Figure~\\ref{fig:CarbonEmissionsGraph} and the top of Figure~\\ref{fig:PrimaryEnergyGraph} in each year.">>=
...
or
carbon intensity of primary energy (\;\!\XCOtwo{}, the prime example for \mft{X}\:)
goes to zero,
CO$_2$ emissions will be eliminated.
Few people want to reduce population~\Pparen{} or affluence~\Aparen{}.
The primary energy intensity of the economy~\REpparen{} is declining
...
reducing the carbon intensity of primary energy~\XCOtwoparen{} is often considered to be the 
...
the carbon intensity of primary energy~\XCOtwoparen{}
...
to the world's primary energy supply.
But how?
...
Interestingly, the rate of change of the impact intensity of primary energy consumption (\rateXCOtwo{})
...
<<E_vs_GDP_graph, fig.scap="World primary energy consumption vs.\\ world GDP", fig.cap = "World primary energy consumption vs.\\ world GDP.">>=
...
\begin{projects}
  ...
  \item Research and rank the EROI\index{energy return on investment (EROI)} of many primary energy sources, 
