...
Even if there were enough land, growing crops requires unsustainable energy,
water, and chemical inputs; see Chapter \ref{chap:agriculture}.

Biomass (unmodified wood or wood pellets) 
works well for home heating and cooking
via wood stoves, 
provided that particulate matter is addressed appropriately.
...
Electrification of personal vehicles is happening from the top end ofthe market, 
...
in plants that convert feedstocks to biofuels.
...
wind and solar (the \emph{WS} in W\emph{WS}) are intermittent sources of electricity,
...
Battery storage on the will require great quantities of rare earth metals 
and other exotic materials, 
already listed on critical materials lists;
see Section~\ref{sec:resources_strong_sustainability}. 
Gravitational potential energy could supply storage with nearly 100\% 
