...
represent sources of some of our sustainability challenges:
...
Revisiting the IPARX identity\index{IPARX identity}, we see that rising population~\Pparen{}, 
rising affluence~\Aparen{}, and
expanded use of fossil fuels~\XCOtwoparen{}
