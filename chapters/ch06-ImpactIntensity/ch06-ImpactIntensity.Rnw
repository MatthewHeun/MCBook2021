...
<<ImpactIntensityGraph, fig.scap="Carbon intensity of energy~(\\;\\!$\\mft{X}_{\\text{CO}_2}$) vs.\\ time", fig.cap="Carbon intensity of energy~(\\;\\!$\\mft{X}_{\\text{CO}_2}$). The line represents the ratio of Figure~\\ref{fig:CarbonEmissionsGraph} and Figure~\\ref{fig:PrimaryEnergyGraph} in each year.">>=
