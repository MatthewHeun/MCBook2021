...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Revisiting the IPARX equation}
...
The thinking goes that either the resource intensity (\:\!\REp{} in the IPARX identity, 
...
the \REp{} or \XCOtwo terms in the IPARX identity.
...
(\:\!\REp{} in the IPARX equation for the prime example) 
is expected to fall, 
...
Revisiting the IPARX equation, we see that rising population~\Pparen{}, 
