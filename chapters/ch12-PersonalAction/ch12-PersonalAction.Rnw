...
This is the second of two chapters on actions that move toward 
...
of the IPARX identity (Equation~\ref{eq:IPARX})
and second by 
...
The lists of individual actions are provided mostly without comment.  
...
Lstiburek shows that not all educators are teachers or professors and not all researchers work
...
Producing less means choosing to have a smaller income. 
To live intentionally off a smaller income,
...
yachts\index{yacht}, mansions\index{mansion}, and private jets\index{jet!private}
contribute significant CO$_2$ emissions
...
Choosing \emph{efficient} (Energy Star)\index{Energy Star}
...
Mike Berners-Lee, \emph{How Bad Are Bananas? The carbon footprint of everything},
