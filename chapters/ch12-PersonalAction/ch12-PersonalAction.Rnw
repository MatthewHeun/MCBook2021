...
so long as appliance and lighting usage is unchanged
...
\item \label{problem:more_actions} 
      ...
      for each row.
      Then, calculate the expected CO$_2$ emissions savings\index{CO$_2$ emissions!reduction} for your new actions.
      Which action is most beneficial for reducing CO$_2$ emissions\index{CO$_2$ emissions!reduction}?
      Why?
