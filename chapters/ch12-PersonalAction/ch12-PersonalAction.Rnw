...
Joseph Lstiburek\index{Lstiburek, Joeseph} is the founding principal of Building Science Corporation and the
...
Wangari Maathai, and Joseph Lstiburek\index{Lstiburek, Joeseph}.
...
\item \label{question:lstiburek}
      In contrast to Wangari Maathai, Joseph Lstiburek\index{Lstiburek, Joeseph} is a much less controversial
