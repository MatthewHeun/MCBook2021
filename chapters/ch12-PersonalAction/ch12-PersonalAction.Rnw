...
(see Chapter~\ref{chap:government}),
...
the $PARC$ terms (Chapters~\ref{chap:population}--\ref{chap:impact_intensity})
...
and perseverance.
His documentation of progress on Twitter could be an example of the sustainability 
sentence: Individual + Education + Impact intensity. 
(See discussion question Q12.\ref{question:mcgregror} for further discussion.)

Wangari Maathai was a veterinary professor, author, 
member of the Kenyan parliament, founder of the Green Belt movement 
(see Q\ref{chap:land_use_urban_planning}.\ref{question:green_wall}),
...
Individuals can adopt a de-growth mindset.
...
via any number of online carbon calculators~\cite{Padgett:2008ws}.
...
both in deciding which homes or apartments to buy or rent
...
Choosing \emph{efficient} (e.g., Energy Star)
...
Even better, choose \emph{not} to use some appliances, e.g., 
line drying clothes.
...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        ...
        and associated discussion.) For more details on what characteristics are 
        desirable in a commuting bicycle, see Not Just Bikes 
...
Individuals can decide which vehicles to buy or rent.
...
(If a truck is needed once per year to pull a trailer, rent.)
...
that flows directly into roadside drains and local waterways.
...
Note: for Questions Q\ref{chap:personal_action}.\ref{question:mcgregror}-
Q\ref{chap:personal_action}.\ref{question:lstiburek} it would be helpful to 
...
\item One example of the sustainability sentence Corporation + Research + Population 
      ...
      How is this different than trusting the human employee of a long-term care facility?
...
\item Every college and university has a History department 
      ...
      The letter should
      (a) identify concrete steps and decisions you will take in your future,
      (b) tie those concrete steps to specific knowledge gained from this book, and 
      (c) list questions that you want your future self to consider.
...
\item Start a blog or social media account dedicated to local politics. 
      ...
      E.g., even if you don't explicitly refer to the IPARX identity, 
