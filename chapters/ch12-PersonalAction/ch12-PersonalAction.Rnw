...
{Leor Hackel and Gregg Sparkman} % on Slate.com Oct. 26, 2018.

This is the second of two chapters on actions to encourage sustainable 
living for individuals and society.
This chapter is a companion to 
Chapter~\ref{chap:government},
which focused on collective ways 
to achieve a sustainable society, 
often by changing the ``rules of the game.''
In contrast, 
this chapter (\ref{chap:personal_action}) focuses on individual actions
that can be taken 
within existing systems, structures, and political environments.
Individual actions are steps that can be taken %by individuals and families
to become more sustainable \emph{in spite of}
...
% OR to contribute to a more sustainable society.
Just as there are many ways that collectives 
can contribute to a more sustainable society
(Chapter~\ref{chap:government}),
there are many ways that individuals can take action
to become more sustainable.
Good thing, too!
Doing nothing (business as usual) is not a good response
to the sustainability challenges that we face 
(see Chapters~\ref{chap:introduction}--\ref{chap:impact_intensity}).
Indeed, doing nothing might be the worst of the possible responses.
...
with \emph{sustainability sentences}, organized first by
the \mft{PARX} terms (Chapters~\ref{chap:population}--\ref{chap:impact_intensity})
of the IPARX equation (Equation~\ref{eq:IPARX})
and second by 
areas of life in which sustainability issues and choices emerge:
households, transportation, agriculture, and land use/urban planning 
(Chapters~\ref{chap:households}--\ref{chap:agriculture}).
The lists of possible personal actions are provided
mostly without comment.  
Readers are encouraged to explore the suggested actions that fit their
local situation, 
...
From 2019--2021, 
Edgar McGregor picked up litter in the Angeles National Forest
...
of trash. 
McGregor's actions illustrate that large, seemingly impossible tasks, like cleaning
...
sentence: Individual + Education + Impact intensity. 
(See discussion Q12.\ref{question:mcgregror} for further discussion.)

Wangari Maathai was a veterinary professor, author, 
member of the Kenyan parliament, founder of the Green Belt movement 
(see Q10.\ref{question:green_wall}),
...
Joseph Lstiburek is the founding principal of Building Science Corporation and the
originator of the perfect wall concept.
Because his research and techniques have lead to building-code improvements that
...
Not all educators are teachers or professors and not all researchers work
for a university or tech start up. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Individual sentences for sustainability}
\label{sec:personal_parc_terms}
\label{sec:personal_parx_terms}
\label{sec:personal_sustainability_challenge_areas}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
To live a more sustainable life, individuals can consider actions
to reduce or limit population growth. 
...
Young families can consider adoption as 
an alternative way to grow a family, and
adoption can be encouraged by making it less expensive.
Not everyone can or will choose these routes for their families, but
if many do, population growth may be slowed.

A deeper commitment to population reduction can be explored
through lifestyle changes.
Individuals can consider monastic life or Christian celibacy, 
...
Individuals can support governmental and non-governmental organizations
...
dollar spent in an economy implies energy and material consumption.
...
and, eventually, returned to nature as waste.
...
material extraction
leads to several recommended personal actions.
...
Producing less means having less of an income. 
To live intentionally off a lower income,
high-earning individuals can pursue a 
``financial independence, retire early'' (FIRE) strategy
across their life. 
FIRE-y individuals earn ``enough'' in their early career
...
You could even donate the land or future development rights of the land 
to a land trust so that the land’s quality can be assured in future generations.
Individuals can (usually easily) choose 
not to be billionaires~\citep{Wilk:2021vg}!
On a per-person basis,
yachts, mansions, and private jets contribute significant CO$_2$ emissions
both when in use and when on standby.
Individuals can adopt a degrowth mindset.
...
goods and services.
Tracking personal carbon emissions is easy
via online carbon calculators~\cite{Padgett:2008ws}.
Resources such as \emph{How bad are bananas?} \cite{Berners-Lee:2011}
...
Individuals can advocate for personal or institutional energy audits
to find energy efficiency and energy savings
opportunities at home, work, school, or church.


%++++++++++++++++++++++++++++++
\subsection{Impact intensity of resources~\Xparen{}}
\label{sec:personal_impact_intensity}
%++++++++++++++++++++++++++++++

Section~\ref{sec:collective_resources} notes that
rising impact intensity of resources~\Xparen{}
leads to increased environmental impacts~\Iparen{}.


%..............................
\paragraph{Individuals+Choices+Impact intensity} 
...
(energy and CO$_2$ emissions).
Individuals can install \emph{renewable} energy generation systems
(typically, solar PV, solar heating, or wind) 
to reduce fossil energy consumption
and limit CO$_2$ emissions. 
Alternatively, individuals can choose to pay a premium for guaranteed 
renewable electricity from the grid.  
Finally, pursuit of \emph{net zero} energy status can encourage
homeowners to balance energy consumption 
with onsite or offsite renewable energy production.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{Sustainability challenge areas}
%\label{sec:personal_sustainability_challenge_areas}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     \end{subfigure}
      \caption[Energy-efficient home with insulated basement]
              {Energy-efficient home with insulated basement.
               The additional insulation will reduce energy consumption 
               and CO$_2$ emissions related to heating and cooling;
...
Choosing a \emph{used} home or apartment
will prevent additional carbon being embodied in the housing stock.
Choosing a \emph{smaller} home will reduce carbon emissions 
associated with heating and cooling.
Choosing a home or apartment \emph{closer} to work, school, grocery stores, and church
will reduce carbon emissions associated with daily and weekly commuting.
Choosing to work from home will eliminate commuting emissions altogether!
In terms of home operation, 
installing additional insulation can reduce energy for heating and cooling.
(See Figure~\ref{fig:energy_efficient_home}.)
Choosing \emph{efficient} (Energy Star)
appliances and lights will improve energy efficiency, 
reduce energy consumption, and 
reduce CO$_2$ emissions so long as appliance and lighting usage is unchanged.
Even better, choose \emph{not} to use some appliances
by, for example, 
line drying clothes.
Choosing to live in \emph{high-occupancy} housing 
(with extended family or in co-housing arrangements)
can reduce energy and resource requirements per person.

At the intersection of households and resource consumption, 
individuals can choose to install renewable energy systems at their dwellings.
Examples of renewable energy systems available for homes include
rooftop solar photovoltaic electricity panels, 
rooftop solar water heaters, 
small wind turbines, and
microhydro power systems.
Installing such a system will reduce the rate at which 
households will consume carbon-intensive resources.
...
Of course, knowing which of the choices above to make requires educating yourself
about options and being aware of tradeoffs.
All consumer purchasing decisions have implications for sustainability through the 
broader economy and the rebound effect.
For example, there are diminishing returns to insulation. 
Buying and installing insulation in your house has positive sustainability 
...
More broadly, there are many actions that are advertised as ``sustainable'' 
but are, in reality, just overconsumption. 
For example, choosing to live ``off grid'' is very expensive relative to on-grid
...
\captionsetup[subfigure]{justification=centering}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         ...
         \caption{An old bicycle.}
         \label{fig:commuting_bicycle}
     \end{subfigure}
        \caption[Two low-carbon commuting options]
        {Two (potentially) low-carbon commuting options. The Tesla shown
        in~(a) could be a low-carbon commuting option, depending on the source of 
        its electricity. On the other hand, the Tesla requires substantial more 
        mineral resource depletion than the bicycle; see Figure~\ref{fig:auto_gwp} 
        and associated discussion.
        For more details on desirable characteristics of
        commuting bicycles, see Not Just Bikes 
...
Choosing a \emph{used} vehicle
will prevent additional carbon being embodied in the vehicle itself.
Choosing a \emph{smaller} car will reduce carbon emissions 
associated with commuting.
Individuals should not ``over buy'' cars.
(If a truck is needed once per year to pull a trailer, rent it.)
Choosing an electric vehicle will reduce CO$_2$ emissions
in those places where grid electricity contains a large proportion of renewables.
...
where vehicle occupancy is high and everyone shares the carbon embodied in the
buses, trains, trolleys, or subways. 
Choosing to walk or bike (Figure~\ref{fig:commuting_bicycle}), 
usually only possible in cities,
further reduces CO$_2$ emissions. 
City dwellers can choose to not buy a car at all, preferring
on-demand rental vehicles from companies
such as Uber, Lyft, or Zip Car
when public transport will not meet their needs.
     ...
     \end{subfigure}
        \caption[Two ways to buy groceries]
                {Two ways to buy groceries.
                 The urban farmers' market offers modest variety of seasonal, locally grown produce. 
                 The suburban grocery store offers a wide variety of internationally-sourced produce.
                 \emph{Sources}: 
...
Individuals have considerable choice of what to eat, where to obtain food, and
how to prepare food. 
...
food is to reduce as much as possible the amount of food waste they generate.
Any wasted food embodies resources (such as energy) and emissions.
Individuals can adopt a climate-friendly or climate-friendlier diet, that is, to
improve the sustainability of \emph{what you eat}.
Typically these involve reductions to meat consumption, particularly beef.
There are a variety of ways to improve the sustainability of \emph{food production}.
Recall that what is least expensive is often the most environmentally friendly.
Cooking at home minimizes packaging and is usually the cheapest option (compared 
to say, buying prepared foods or eating at a restaurant).
Buy \emph{ingredients} (see Figure~\ref{fig:suburban_produce_aisle}), then 
\emph{make} food.
One step beyond that would be to raise your own food by gardening or harvest 
wild food, for instance by hunting, fishing, and/or gathering wild plants. 
One side benefit to such foraging is an investment in the state of the ecosystem.
A partial measure is buying direct from local farmers, perhaps at a farmers' 
market (see Figure~\ref{fig:urban_farmers_market}) or through community-supported 
agriculture.

\paragraph{Individual+Research+Agriculture}
The examples in the previous paragraph are based on general assumptions about what
is most likely to be sustainable behavior.
You could collect personal data to quantify what is most sustainable in your 
particular context or situation.
For example, perhaps you could develop a new meatless version of a favorite recipe.
Another example would be to collect data on what plants do best in your garden and
to record what inputs (water, fertilizer, your time) are required, which would
allow you to optimize your gardening for maximum sustainability impact.
...
\captionsetup[subfigure]{justification=centering}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         ...
         \caption{Kentucky bluegrass farming.}
     ...
     \end{subfigure}
        \caption[Two ways to adorn lawns]
                {Two ways to adorn lawns.
                 ...
                 The gutter cut-out reduces pollution by diverting rainwater
...
Where you live is a key land-use decision in the sense that it determines how you
relate to all the land around you, mainly through your transportation.
However, how you use your domicile is also important.
...
Get involved in your local zoning board, drain commission, or other local government entity. 
Advocate for local \emph{and} regional solutions. 
Being involved in local politics is one of the best ways to make a difference for 
sustainability;
see P12.\ref{problem:blog_social_media}.
...
College and university students are at a very important time in their lives.
Decisions made in the next few years will set the course of
interactions with the environment for decades to come. 
As you embark on that process, 
ask yourself the questions shown in Table~\ref{tab:personal_energy_actions}.
The questions crystallize many possible individual actions discussed throughout this book.
...
Figure~\ref{fig:CO2-Savings} provides estimates of the CO$_2$ emissions savings 
from one example action for each row in Table~\ref{tab:personal_energy_actions}.


\begin{table}
\caption[Personal sustainability Q\&A]{Individual sustainability actions Q\&A.}
\centering
\begin{tabular}{l l}
\toprule
Question                                    & Sustainability-beneficial answer       \\ 
\midrule
How close will I live to work,              & \multirow{2}{*}{Close enough to allow walking and cycling} \\
school, church, and stores?                 &                                        \\
What kind of house will I buy?              & Small and used                         \\
How will I eat?                             & Close to the bottom of the food chain  \\   
What kind of car will I drive?              & Small and used                         \\
...
<<CO2-Savings_old, fig.width=3, fig.height=4, fig.scap="CO$_2$ savings from individual actions", fig.cap="CO$_2$ emission savings from example actions for rows in Table~\\ref{tab:personal_energy_actions}. ``No commute'' means living close enough to walk or bike to work instead of commuting 50~miles each-way, 230 times/year with a Honda Accord. ``Smaller home'' means living in a 1250~ft$^2$ home instead of a 2750~ft$^2$ home. ``Chicken, not steak'' means choosing 6~ounces of chicken instead of 6~ounces of steak 25 times per year. ``Accord, not F150'' means driving 12,000~miles/year with a Honda Accord instead of a Ford F150. ``No NYC$\\rightarrow$LHR'' means eliminating one New-York-to-London round trip flight in economy class per year. \\emph{Source}: own calculations.">>=
co2_savings <- readxl::read_excel(file.path("chapters", "ch12-PersonalAction", "datasets", "CO2Savings.xlsx"),
                                  sheet = "data to use old") %>% 
  dplyr::mutate(
    Action = dplyr::case_when(
      Action == "No commute" ~ "No~commute", 
      Action == "Smaller home" ~ "Smaller~home", 
      Action == "Chicken, not steak" ~ "list(Chicken, not~steak)", 
      Action == "Accord, not F150" ~ "list(Accord, not~F150)", 
      Action == "No NYC->LHR" ~ "No~NYC%->%LHR"
    ),
    Action = factor(Action, levels = c("No~commute", "Smaller~home", "list(Chicken, not~steak)", 
                                       "list(Accord, not~F150)", "No~NYC%->%LHR")), 
    Savings_MgCO2_year = Savings_kgCO2_year / 1000
  )

x_breaks <- levels(co2_savings$Action)
x_labels <- parse(text = x_breaks)

co2_savings %>% 
  ggplot2::ggplot(mapping = ggplot2::aes(x = Action, y = Savings_MgCO2_year)) + 
  ggplot2::geom_bar(stat = "identity", fill = bar_colour) + 
  
  ggplot2::scale_x_discrete(labels = parse(text = levels(co2_savings$Action))) + 

  ggplot2::labs(x = ggplot2::element_blank(), 
                y = expression("Emissions savings [Mg" * CO[2] * "/year]")) + 
...
<<CO2-Savings, fig.scap="CO$_2$ savings from individual actions", fig.cap="CO$_2$ emission savings from example actions for rows in Table~\\ref{tab:personal_energy_actions}. Choices are arranged left-to-right from most impactful to least impactful. Living ``close enough to walk or cycle to work'' is represented by the choice of a 100-mile-round-trip commute with a Honda Accord or cycling or walking to work 230 times/year. Housing size is represented by ``1250~ft$2$'' home vs.\\ a ``2750~ft$^2$ home. Eating closer to the bottom of the food chain is represented by the choice between 6~ounces of poultry vs.\\ 6~ounces of steak 25~meals/year. Transportation options are represented by the choice between driving a Honda Accord sedan or a Ford F150 truck 12,000 miles/year. Flying little or not at all is represented by choosing a virtual meeting or one round-trip flight between New York and London per year. \\emph{Source}: own calculations.">>=
co2_savings <- readxl::read_excel(file.path("chapters", "ch12-PersonalAction", "datasets", "CO2Savings.xlsx"),
                                  sheet = "data to use") %>% 
  dplyr::mutate(
    ...
    Choice = factor(Choice, levels = c("100~miles/day", "Cycle~or~walk", 
                                       ...
                                       "Steak", "Chicken", 
                                       "F150", "Accord", 
                                       "NYC%->%LHR%->%NYC", "Virtual~meeting")),
    `CO2 emissions [Mg/year]` = `CO2 emissions [kg/year]` / 1000
  )

x_breaks <- levels(co2_savings$Choice)
x_labels <- parse(text = x_breaks)
...
co2_savings %>% 
  ...
  ggplot2::scale_x_discrete(labels = parse(text = levels(co2_savings$Choice))) + 
  ggplot2::scale_fill_manual(values = c(`Less sustainable` = data_line_colour, 
                                        `More sustainable` = curve_fit_colour)) + 

  ggplot2::labs(x = ggplot2::element_blank(), 
                y = expression("Emissions [Mg" * CO[2] * "/year]"), 
...
Note: for
Q12.\ref{question:mcgregror}--Q12.\ref{question:lstiburek} 
it will help to read about
Edgar McGregor, \emph{Juliana v.\ United States},
Wangari Maathai, and Joseph Lstiburek.

\begin{questions}

\item While laudable and environmentally friendly, were Edgar McGregor's actions
      (Section~\ref{sec:stories_individual_actions}) \emph{necessary} for 
      \emph{sustanability}?
      To put it another way, would the park have continued to function as a park if 
      Edgar McGregor had not removed the litter?
      The Los Angeles County Department of Parks and Recreation is in charge of
      ``his'' park. 
      How do McGregor's actions affect their stewardship of the park, and,
      in particular, their clean-up efforts?
      Compare and contrast the behavior of McGregor with Bill Peterson from 
      Q11.\ref{question:trailer_trash}.
      \label{question:mcgregror}

\item The case \emph{Juliana v. United States} is a climate-related lawsuit filed
      against the United States, similar in some respects to the suit mentioned
      in Q1.\ref{question:shell_lawsuit}.
      ...
      One judge, Josephine Stanton, dissented from that decision to dismiss and wrote 
      ``the mere fact that this suit cannot alone halt climate change does not 
      ...
      However, when the dismissal was appealed \emph{en banc}, that is, to the
      full court, the appeal was denied without written dissent, meaning that 
      Judge Stanton did not (in writing, at least) object to the denial of the appeal.
      What can you infer about Judge Stanton's problem-solving approach from this story?
      Compare and contrast the problem-solving approach and conduct of 
      Judge Stanton with that of Edgar McGregor and Bill Peterson.
      Which approach is most relevant for you?
      
\item Wangari Maathai (Section~\ref{sec:stories_individual_actions}) was jailed
      many times in her life for her protests.
      How were her aims the same or different from Edgar McGregor and/or Bill Peterson?
...
\item In contrast to Wangari Maathai, Joseph Lstiburek is a much less controversial
...
\item One example of the sustainability sentence Corporation + Research + Population 
      is the use of robots for elder care in Japan.
      ``Rapid population aging and the shortage of caregivers have spurred the 
      government to promote the use of robots in nursing homes. 
      As part of its robot strategy, the government began to provide robot 
      subsidies to nursing homes in 2015. Already by 2016, about 15\% of the 
      country’s nursing homes had adopted robots''~\cite{aparc_fsi}.
      What are the humanitarian implications of substituting robots for human 
      caregivers for a vulnerable segment of the population?
      Given Japan's aging population and shrinking workforce, what are the concerns
      about \emph{not} using robot caregivers?
      Fundamentally, do you believe that robots ever could substitute for human 
      caregivers?
      Is it even theoretically possible for robots to become substitutable for human
      relationships? 
      What reasoning or beliefs lie behind your answer?
      What are your feelings about the \emph{corporations} that develop
      and manufacture the robots?
      Would you trust your relative to a robot? Yourself to a robot?
...
\item Which sustainability sentence holds greater appeal to you: Government + 
      Research + Housing \emph{or} Corporation + Research + Housing? Why?
      What if we substituted the action Education for Research?
      How do you see each of these options as affecting your own possible 
      Choice actions? How about your life more broadly?
      
\item Which sustainability sentence holds greater appeal to you: Government + 
      Research + Transportation \emph{or} Corporation + Research + Transportation? Why?
      What if we substituted the action Education for Research?
      How do you see each of these options as affecting your own possible 
      Choice actions? How about your life more broadly?
...
\item What Choices do you have for reducing food waste?

\item What are your reactions to the suggestion that hunting, fishing, or foraging
...
\item One of the sustainability suggestions from 
      ...
      Does desirability of the land for any other purpose (say, hunting, farming, 
...
\item The line between individual and collective action can be blurry.
      Because humans live in societies, 
      every collective action is composed of many individual actions.
      P4.\ref{project:off-grid} illustrates the impossibility 
      of trying to divorce the individual from the collective. 
      Do you consider voting an individual action or a collective action? 
      How about going to a climate-change rally? 
      Are oprganizing and attending the rally on different sides of the line?
      Wangari Maathai (Section~\ref{sec:stories_individual_actions})
      was an originator of the Green Belt Movement. 
      Was organizing the Green Belt Movement an individual or collective action? 
      Do you consider individual or collective actions to be more valuable for sustainability? 
      Is individual vs.\ collective a helpful framework
...
\item Looking back over the last ten years of your life, create a 
      \emph{sustainability scorecard} for your life. 
      Is your scorecard multifaceted?
      Does it involve the three aspects of sustainability (Figure~\ref{fig:venn_diagram}), 
      the IPARX equation (\ref{eq:IPARX}), and the sustainability challenge
...
\item Every college and university has a History department 
      that reinterprets the past in light of the present. 
      No colleges or universities (to our knowledge) 
      have a Department of the Future. 
      If colleges and universities had a Department of the Future, 
...
\item Conduct an energy audit on your home, work, school, or church.
      ...
      How can you mitigate the rebound effect for your changes?
      \label{project:personal_energy_audit}
      
\item Analyze any changes suggested by the results of project 
      P\ref{chap:personal_action}.\ref{project:personal_energy_audit}
      in three ways: from a cost/benefit standpoint (that is, \emph{monetary}), 
      in terms of embodied \emph{energy} versus energy savings, 
      and in terms of embodied \emph{carbon} emissions versus carbon emissions reductions 
      ...
      ``an [electric vehicle] that is totaled shortly after manufacture will 
      never achieve its potential emissions reductions.'')
      
\item Use a scale and dedicated trash receptacles to track your food use and waste 
      over a 30-day period. 
      Weigh all the food that comes into your house.
      Weigh all the packaging waste (receptacle \#1).
      Weigh all the food waste (receptacle \#2).
      What patterns to you notice?
      Where are opportunities for enhanced sustainability?
      Research the carbon coefficients for different kinds of food and food packaging.
      What is having a greater impact, your food waste or food packaging?
      
\item Start a blog or social media account dedicated to local politics. 
      Pick a local political office or body, like the city council, county drain
      commission, zoning board of appeals, or school board.
      ...
      over the long term.
      Report on what issues your representative government officials face. 
      What do you notice that \emph{isn't} coming before them?
      ...
      For example, even if you don't explicitly refer to the IPARX identity, 
      ...
      Even if you don't discuss ``sustainability sentences,''
      does the SUBJECT+ACTION+OBJECT framing assist your reporting
      on local politics? \label{problem:blog_social_media}
      
\item Chapter~\ref{chap:affluence} demonstrated that economic activity leads to environmental impacts.
      The FIRE strategy for sustainability
      is to earn enough money early in a career, living simply thereafter.
      Under what conditions will the FIRE (financial independence, retire early) strategy
      actually lead to a more sustainable life?
      Does it matter for sustainability \emph{when} money is earned by an individual? 
      Early, mid, or late career?
      Be sure to define the FIRE career and 
      carefully consider the point of comparison for determining the sustainability of a FIRE life.
      How would you rate the sustainability of 
      an individual who lives a \$1M/year lifestyle for 40 years of a career vs.\
      an individual who lives a \$4M/year lifestyle for 10 years and \$0M/year for 30 years thereafter.
      What about an individual who lives the \$1M/year lifestyle 
      for 10 years and \$0M/year for 30 years thereafter.
      
\item Investigate renewable energy systems for your dwelling, 
      including rooftop solar photovoltaic panels, 
      solar water heating, 
...
\item Consider another sustainability challenge are besides 
      ...
      Finally, consider the collective and individual actions 
...
\item Figure~\ref{fig:CO2-Savings} shows an example sustainability-beneficial action
      for each row of Table~\ref{tab:personal_energy_actions}.
      Verify the calculation of CO$_2$ emissions savings presented 
      in Figure~\ref{fig:CO2-Savings}.
      There are many possible sustainability-related actions 
      for each row of Table~\ref{tab:personal_energy_actions}.
      Think of one different sustainability-related action 
      for each row.
      Then, calculate the expected CO$_2$ emissions savings for your new actions.
      Which action is most beneficial for reducing CO$_2$ emissions?
      Why?
