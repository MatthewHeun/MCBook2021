...
renewable electricity from the grid\index{grid electricity}.
...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        ...
        On the other hand, the Tesla\index{Tesla} requires substantially more 
