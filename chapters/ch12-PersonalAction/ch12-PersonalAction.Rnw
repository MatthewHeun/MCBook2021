...
non-governmental organizations\index{non-governmental organizations (NGOs)}
...
Get involved in your local zoning board, drain commission, or other local government\index{government!local} entity. 
...
\item One example of the sustainability sentence Corporation + Research + Population 
      ...
      government\index{government} to promote the use of robots in nursing homes. 
      As part of its robot strategy, the government\index{government} began to provide robot 
...
\item \label{problem:blog_social_media}
      ...
      does the ACTOR\index{actor}+ACTION+ARENA framing assist your reporting
      on local politics? 
