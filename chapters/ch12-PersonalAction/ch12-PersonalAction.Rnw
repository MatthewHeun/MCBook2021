...
\begin{figure}
\centering
\includegraphics[width=\figwidth]{chapters/ch12-PersonalAction/photos/fill_photo_landscape.jpeg}
\caption{Energy-efficient home.}
...
\begin{figure}
     ...
     \end{subfigure}
        \caption{Two ways to sell groceries.}
        \label{fig:food_selling_options}
\end{figure}
