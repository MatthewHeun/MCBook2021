...
\item Analyze any changes suggested by the results of project 
      ...
      What changes to embodied energy and embodied emissions are entailed 
      in the changes you are considering?
      Do the energy saving and/or emissions reductions justify the embodied
      energy/emissions? If so, over what time frame?
...
\item Start a blog or social media account dedicated to local politics. 
      ...
      Imagine that you are a reporter documenting sustainability issues over the long term.
