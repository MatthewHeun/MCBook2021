...
Again, like Chapter~\ref{chap:government}, 
there are many ways that individuals can take action
to become more sustainable. 
This chapter opens with stories of individuals striving to live
...
the $PARC$ terms (Chapters~\ref{chap:population}--\ref{chap:carbon_intensity})
of the IPARC equation (Equation~\ref{eq:IPARC})
and second by 
...
by Chapters~\ref{chap:introduction}--\ref{chap:carbon_intensity}.
...
sentence: Individual + Education + Contamination. 
(See discussion question Q11.\ref{question:mcgregror} for further discussion.)
...
%++++++++++++++++++++++++++++++
\subsection{Resource intensity of the economy ($R$)}
\label{sec:personal_resources}
%++++++++++++++++++++++++++++++

Section~\ref{sec:collective_resources} notes that
declining resource intensity ($R$)
reduces environmental impacts ($I$).
...
%++++++++++++++++++++++++++++++
\subsection{Contamination intensity of resources ($C$)}
\label{sec:personal_contamination_intensity}
%++++++++++++++++++++++++++++++

Section~\ref{sec:collective_resources} notes that
rising contamination intensity of resources ($C$)
leads to increased environmental impacts ($I$).


%..............................
\paragraph{Individuals+Choices+Contamination intensity} 
\label{sec:individuals+choices+comtemination_intensity}
%..............................

Thankfully, there are many ways individuals can reduce contamination
...
\item One of the sustainability suggestions from 
      Section~\ref{sec:personal_affluence} is to buy land and hold it for 
      conservation.
...
\item Looking back over the last ten years of your life, create a 
      ...
      Does it involve the three pillars (Figure~\ref{fig:venn_diagram}), 
      the IPARC equation (\ref{eq:IPARC}), and the sustainability challenge
...
\item Start a blog or social media account dedicated to local politics. 
      ...
      E.g., even if you don't explicitly refer to the IPARC identity, 
