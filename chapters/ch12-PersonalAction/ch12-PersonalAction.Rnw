...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        ...
        its electricity. On the other hand, the Tesla requires substantially more 
...
co2_amounts %>% 
  ...
  ggplot2::labs(x = ggplot2::element_blank(), 
                y = expression("Emissions [t" * CO[2] * "/year]"), 
...
\item Which sustainability sentence holds greater appeal to you: 
      Government+Research+Housing \emph{or} 
...
\item Which sustainability sentence holds greater appeal to you: 
      Government+Research+Transportation \emph{or}
