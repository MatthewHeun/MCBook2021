...
\captionsetup[subfigure]{justification=centering}
     ...
     \end{subfigure}
        ...
        its electricity. On the other hand, the Tesla\index{Tesla} requires substantially more 
